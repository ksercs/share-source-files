...
var Scheduler = /*#__PURE__*/function (_Widget) {
  ...
  _proto._customizeDataSourceLoadOptions = function _customizeDataSourceLoadOptions() {
    var _this$_dataSource,
      _this4 = this;
    (_this$_dataSource = this._dataSource) === null || _this$_dataSource === void 0 ? void 0 : _this$_dataSource.on('customizeStoreLoadOptions', function (_ref) {
  ...
  _proto._appointmentsConfig = function _appointmentsConfig() {
    ...
    var config = {
      ...
      getDOMElementsMetaData: function getDOMElementsMetaData() {
        ...
        return (_this13$_workSpace = _this13._workSpace) === null || _this13$_workSpace === void 0 ? void 0 : _this13$_workSpace.getDOMElementsMetaData();
      },
      getViewDataProvider: function getViewDataProvider() {
        var _this13$_workSpace2;
        return (_this13$_workSpace2 = _this13._workSpace) === null || _this13$_workSpace2 === void 0 ? void 0 : _this13$_workSpace2.viewDataProvider;
      },
      isVerticalViewDirection: function isVerticalViewDirection() {
        return _this13.getRenderingStrategyInstance().getDirection() === 'vertical';
      },
      ...
      onContentReady: function onContentReady() {
        ...
        (_this13$_workSpace3 = _this13._workSpace) === null || _this13$_workSpace3 === void 0 ? void 0 : _this13$_workSpace3.option('allDayExpanded', _this13._isAllDayExpanded());
      }
    };
    return config;
  };
  ...
  _proto.showAppointmentPopup = function showAppointmentPopup(rawAppointment, createNewAppointment, rawTargetedAppointment) {
    ...
    if (isCreateAppointment) {
      ...
      this._checkRecurringAppointment(rawAppointment, newTargetedAppointment, appointment.startDate, function () {
        _this23._editAppointmentData = rawAppointment; // TODO
