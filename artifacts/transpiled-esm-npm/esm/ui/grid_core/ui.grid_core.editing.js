...
var EditingController = modules.ViewController.inherit(function () {
  ...
  var members = {
    ...
    _navigateToNewRow: function _navigateToNewRow(oldEditRowIndex, change, editRowIndex) {
      ...
      d.done(() => {
        var _this$_rowsView;
        (_this$_rowsView = this._rowsView) === null || _this$_rowsView === void 0 ? void 0 : _this$_rowsView.waitAsyncTemplates(true).done(() => {
    ...
    _updateRowWithDelay: function _updateRowWithDelay(row, isCustomSetCellValue) {
      ...
      setTimeout(() => {
        ...
        // @ts-expect-error
        var elementContainer = ((_this$_editForm = this._editForm) === null || _this$_editForm === void 0 ? void 0 : _this$_editForm.element()) || this.component.$element().get(0);
