  ...
  var members = {
    ...
    _handleDataLoaded: function _handleDataLoaded(options) {
      ...
      if (!needPageCache || !getPageDataFromCache(options)) {
        ...
        if (!loadOptions.data && (storeLoadOptions.requireTotalCount || ((_options$extra$totalC = (_options$extra = options.extra) === null || _options$extra === void 0 ? void 0 : _options$extra.totalCount) !== null && _options$extra$totalC !== void 0 ? _options$extra$totalC : -1) >= 0)) {
          this._totalCountCorrection = 0;
        }
