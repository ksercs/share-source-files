...
(["node_modules/knockout/build/output/knockout-latest.debug.js"], [], true, function($__System) {
  ...
  (function(undefined) {
    ...
    (function(factory) {
        ...
        "notifySubscribers": function(valueToNotify, event) {
          ...
          if (this.hasSubscriptionsForEvent(event)) {
            ...
            try {
              ...
              for (var i = 0,
                  subscription; subscription = subs[i]; ++i) {
      ...
      ko.isWriteableObservable = function(instance) {
        return (typeof instance == 'function' && ((instance[protoProperty] === observableFn[protoProperty]) || (instance[protoProperty] === ko.computed['fn'][protoProperty] && instance.hasWriteFunction)));
      };
      ...
      ko.expressionRewriting = (function() {
        ...
        var specials = ',"\'`{}()/:[\\]',
            bindingToken = RegExp(['"(?:\\\\.|[^"])*"', "'(?:\\\\.|[^'])*'", "`(?:\\\\.|[^`])*`", "/\\*(?:[^*]|\\*+[^*/])*\\*+/", "//.*\n", '/(?:\\\\.|[^/])+/\w*', '[^\\s:,/][^' + specials + ']*[^\\s' + specials + ']', '[^\\s]'].join('|'), 'g'),
      ...
      (function(undefined) {
            ...
            ko.computed(function() {
              ...
              ko.components.get(componentName, function(componentDefinition) {
                ...
                var componentViewModel = createViewModel(componentDefinition, componentParams, componentInfo),
                    childBindingContext = asyncContext['createChildContext'](componentViewModel, {'extend': function(ctx) {
        ...
        function createViewModel(componentDefinition, componentParams, componentInfo) {
          ...
          return componentViewModelFactory ? componentViewModelFactory.call(componentDefinition, componentParams, componentInfo) : componentParams;
        }
      })();
      ...
      ko.bindingHandlers['class'] = {'update': function(element, valueAccessor) {
      ...
      ko.bindingHandlers['let'] = {'init': function(element, valueAccessor, allBindings, viewModel, bindingContext) {
      ...
      ko.bindingHandlers['using'] = {'init': function(element, valueAccessor, allBindings, viewModel, bindingContext) {
          var options;
      ...
      ko.bindingHandlers['hidden'] = {'update': function(element, valueAccessor) {
      ...
      (function() {
        ...
        ko.utils.setDomNodeChildrenFromArrayMapping = function(domNode, array, mapping, options, callbackAfterAddingNodes, editScript) {
          ...
          function itemAdded(value) {
            mapData = {
              arrayEntry: value,
              indexObservable: ko.observable(currentArrayIndex++)
            };
          ...
          if (isFirstExecution) {
            ...
            for (var i = 0,
                editScriptItem,
                movedIndex,
                itemIndex; editScriptItem = editScript[i]; i++) {
