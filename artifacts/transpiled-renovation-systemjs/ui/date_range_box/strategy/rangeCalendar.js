...
(["artifacts/transpiled-renovation/ui/date_range_box/strategy/rangeCalendar.js"], ["../../../core/renderer","../../date_box/ui.date_box.strategy.calendar","../../../core/utils/extend","../ui.date_range.utils","../../../core/utils/type"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/date_range_box/strategy/rangeCalendar.js", ["../../../core/renderer", "../../date_box/ui.date_box.strategy.calendar", "../../../core/utils/extend", "../ui.date_range.utils", "../../../core/utils/type"], true, function ($__require, exports, module) {
  "use strict";
    ...
    _proto.supportedKeys = function supportedKeys() {
      ...
      var supportedKeys = _extends({}, _CalendarStrategy.prototype.supportedKeys.call(this), {
        ...
        enter: function enter(e) {
          if (_this3.dateRangeBox.option('opened')) {
            _this3.dateRangeBox.getStartDateBox()._strategy._widget._enterKeyHandler(e);
            _this3.dateBox._valueChangeEventHandler(e);
            _this3.dateRangeBox.getStartDateBox()._strategy._widget.option('values', _this3.dateRangeBox.option('value'));
            return false;
          }
        }
      });
