...
(["artifacts/transpiled-renovation/ui/grid_core/ui.grid_core.column_fixing.js"], ["../../core/utils/size","../../core/renderer","../../events/core/events_engine","../../events/core/wheel","../../localization/message","../grid_core/ui.grid_core.utils","../../core/utils/type","../../core/utils/extend","../../core/utils/iterator","../../core/utils/browser","../../core/utils/position","../../animation/translator","../scroll_view/ui.scrollable"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/grid_core/ui.grid_core.column_fixing.js", ["../../core/utils/size", "../../core/renderer", "../../events/core/events_engine", "../../events/core/wheel", "../../localization/message", "../grid_core/ui.grid_core.utils", "../../core/utils/type", "../../core/utils/extend", "../../core/utils/iterator", "../../core/utils/browser", "../../core/utils/position", "../../animation/translator", "../scroll_view/ui.scrollable"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var baseFixedColumns = {
    ...
    getTableElement: function getTableElement(isFixedTableRendering) {
    ...
    setTableElement: function setTableElement(tableElement, isFixedTableRendering) {
      if (this._isFixedTableRendering || isFixedTableRendering) {
  ...
  var RowsViewFixedColumnsExtender = (0, _extend.extend)({}, baseFixedColumns, {
    ...
    _getScrollDelay: function _getScrollDelay() {
      var _this$getController;
      var hasResizeTimeout = (_this$getController = this.getController('resizing')) === null || _this$getController === void 0 ? void 0 : _this$getController.hasResizeTimeout();
      if (hasResizeTimeout) {
        return this.option('scrolling.updateTimeout');
      }
      return _browser.default.mozilla ? 60 : 0;
    },
    _findContentElement: function _findContentElement(isFixedTableRendering) {
      var _this4 = this;
      var $content;
      var scrollTop;
    ...
    _renderContent: function _renderContent(contentElement, tableElement, isFixedTableRendering) {
      if (this._isFixedTableRendering || isFixedTableRendering) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/size","../../core/renderer","../../events/core/events_engine","../../events/core/wheel","../../localization/message","../grid_core/ui.grid_core.utils","../../core/utils/type","../../core/utils/extend","../../core/utils/iterator","../../core/utils/browser","../../core/utils/position","../../animation/translator","../scroll_view/ui.scrollable"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/size"), require("../../core/renderer"), require("../../events/core/events_engine"), require("../../events/core/wheel"), require("../../localization/message"), require("../grid_core/ui.grid_core.utils"), require("../../core/utils/type"), require("../../core/utils/extend"), require("../../core/utils/iterator"), require("../../core/utils/browser"), require("../../core/utils/position"), require("../../animation/translator"), require("../scroll_view/ui.scrollable"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.grid_core.column_fixing.js.map