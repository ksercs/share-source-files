...
(["artifacts/transpiled-renovation/ui/calendar/ui.calendar.range.selection.strategy.js"], ["../../core/utils/date","./ui.calendar.selection.strategy"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/calendar/ui.calendar.range.selection.strategy.js", ["../../core/utils/date", "./ui.calendar.selection.strategy"], true, function ($__require, exports, module) {
  "use strict";
  ...
  var _uiCalendarSelection = _interopRequireDefault($__require("./ui.calendar.selection.strategy"));
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../core/utils/date","./ui.calendar.selection.strategy"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../core/utils/date"), require("./ui.calendar.selection.strategy"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=ui.calendar.range.selection.strategy.js.map