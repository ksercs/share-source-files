...
(["artifacts/transpiled-renovation/ui/drop_down_button.js"], ["../core/renderer","./widget/ui.widget","../core/templates/function_template","../core/component_registrator","./button_group","./popup/ui.popup","./list_light","../core/utils/data","../core/element","../core/utils/icon","../data_helper","../data/data_source/data_source","../data/array_store","../core/utils/deferred","../core/utils/extend","../core/utils/type","../core/utils/common","../core/guid","./drop_down_editor/utils","../localization/message"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic("artifacts/transpiled-renovation/ui/drop_down_button.js", ["../core/renderer", "./widget/ui.widget", "../core/templates/function_template", "../core/component_registrator", "./button_group", "./popup/ui.popup", "./list_light", "../core/utils/data", "../core/element", "../core/utils/icon", "../data_helper", "../data/data_source/data_source", "../data/array_store", "../core/utils/deferred", "../core/utils/extend", "../core/utils/type", "../core/utils/common", "../core/guid", "./drop_down_editor/utils", "../localization/message"], true, function ($__require, exports, module) {
  "use strict";
