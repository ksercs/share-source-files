...
var EditingController = _uiGrid_core.default.ViewController.inherit(function () {
  ...
  var members = {
      ...
      changes.forEach(function (change) {
        if (change.type === 'insert') {
          ...
          _this7._addInternalData({
            key: change.key,
            oldData: (_items$rowIndex = items[rowIndex]) === null || _items$rowIndex === void 0 ? void 0 : _items$rowIndex.data
          });
        }
      });
    ...
    isEditRowByIndex: function isEditRowByIndex(rowIndex) {
      var key = this._dataController.getKeyByRowIndex(rowIndex);
    ...
    _navigateToNewRow: function _navigateToNewRow(oldEditRowIndex, change, editRowIndex) {
      ...
      d.done(function () {
        ...
        (_this13$_rowsView = _this13._rowsView) === null || _this13$_rowsView === void 0 ? void 0 : _this13$_rowsView.waitAsyncTemplates(true).done(function () {
    ...
    _updateRowWithDelay: function _updateRowWithDelay(row, isCustomSetCellValue) {
      ...
      setTimeout(function () {
        ...
        // @ts-expect-error
        var elementContainer = ((_this29$_editForm = _this29._editForm) === null || _this29$_editForm === void 0 ? void 0 : _this29$_editForm.element()) || _this29.component.$element().get(0);
        ...
        if (columnIndex >= 0) {
          ...
          _this29._delayedInputFocus($focusedItem, function () {
            setTimeout(function () {
              ...
              // @ts-expect-error
              focusedElement = _dom_adapter.default.getActiveElement((_this29$component$$el = _this29.component.$element()) === null || _this29$component$$el === void 0 ? void 0 : _this29$component$$el.get(0));
    ...
    highlightDataCell: function highlightDataCell($cell, params) {
    ...
    shouldHighlightCell: function shouldHighlightCell(parameters) {
    ...
    views: {
      rowsView: {
        ...
        _cellPrepared: function _cellPrepared($cell, parameters) {
          ...
          var hasTemplate = !!((_parameters$column = parameters.column) !== null && _parameters$column !== void 0 && _parameters$column.cellTemplate);
