    ...
    data: _uiGrid_core.default.Controller.inherit({}).include(_data_helper.default).inherit(function () {
      ...
      var members = {
        ...
        optionChanged: function optionChanged(args) {
          ...
          if (args.name === 'dataSource' && args.name === args.fullName
          // @ts-expect-error
        ...
        _handleColumnsChanged: function _handleColumnsChanged(e) {
          ...
          var updateItemsHandler = function updateItemsHandler(change) {
            ...
            that.updateItems({
              repaintChangesOnly: false,
              virtualColumnsScrolling: change === null || change === void 0 ? void 0 : (_change$changeTypes = change.changeTypes) === null || _change$changeTypes === void 0 ? void 0 : _change$changeTypes.virtualColumnsScrolling
            });
          };
        ...
        _applyChangesOnly: function _applyChangesOnly(change) {
          ...
          var items = [];
          var newIndexByKey = {};
          var isLiveUpdate = (_change$isLiveUpdate = change === null || change === void 0 ? void 0 : change.isLiveUpdate) !== null && _change$isLiveUpdate !== void 0 ? _change$isLiveUpdate : true;
