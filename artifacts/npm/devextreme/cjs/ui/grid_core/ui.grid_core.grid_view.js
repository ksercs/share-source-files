...
var resizingControllerMembers = {
  ...
  updateSize: function updateSize(rootElement) {
    ...
    if (that._hasHeight === undefined && $rootElement && $rootElement.is(':visible') && (0, _size.getWidth)($rootElement)) {
      var $groupElement = $rootElement.children('.' + that.getWidgetContainerClass());
  ...
  _waitAsyncTemplates: function _waitAsyncTemplates() {
    ...
    return (0, _deferred.when)((_this$_columnHeadersV = this._columnHeadersView) === null || _this$_columnHeadersV === void 0 ? void 0 : _this$_columnHeadersV.waitAsyncTemplates(), (_this$_rowsView = this._rowsView) === null || _this$_rowsView === void 0 ? void 0 : _this$_rowsView.waitAsyncTemplates(), (_this$_footerView = this._footerView) === null || _this$_footerView === void 0 ? void 0 : _this$_footerView.waitAsyncTemplates());
  },
  ...
  _checkSize: function _checkSize(checkSize) {
    ...
    if (checkSize && (this._lastWidth === (0, _size.getWidth)($rootElement) && this._lastHeight === (0, _size.getHeight)($rootElement) && this._devicePixelRatio === (0, _window.getWindow)().devicePixelRatio ||
    // @ts-expect-error
