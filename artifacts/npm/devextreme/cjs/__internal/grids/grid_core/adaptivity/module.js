...
var adaptiveColumnsControllerMembers = {
  ...
  getAdaptiveDetailItems: function getAdaptiveDetailItems() {
  ...
  extenders: {
    ...
    controllers: {
      ...
      data: {
        ...
        toggleExpandAdaptiveDetailRow: function toggleExpandAdaptiveDetailRow(key, alwaysExpanded) {
          var that = this;
          var oldExpandLoadedRowIndex = _module_utils.default.getIndexByKey(that._adaptiveExpandedKey, that._items);
          var newExpandLoadedRowIndex = _module_utils.default.getIndexByKey(key, that._items);
