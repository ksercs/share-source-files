...
class ToolbarBase extends AsyncCollectionWidget {
  ...
  _arrangeItems(elementWidth) {
    var _elementWidth;
    elementWidth = (_elementWidth = elementWidth) !== null && _elementWidth !== void 0 ? _elementWidth : getWidth(this.$element());
  ...
  _updateDimensionsInMaterial() {
    if (isMaterial()) {
      var _waitParentAnimationFinished = () => {
      ...
      var _checkWebFontForLabelsLoaded = () => {
