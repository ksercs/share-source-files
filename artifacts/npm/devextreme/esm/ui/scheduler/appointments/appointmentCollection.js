    ...
    return extend(parent, {
      escape: function () {
        if (this.resizeOccur) {
          ...
          (_currentAppointment$d = currentAppointment.dxResizable('instance')) === null || _currentAppointment$d === void 0 ? void 0 : _currentAppointment$d._detachEventHandlers();
          (_currentAppointment$d2 = currentAppointment.dxResizable('instance')) === null || _currentAppointment$d2 === void 0 ? void 0 : _currentAppointment$d2._attachEventHandlers();
          (_currentAppointment$d3 = currentAppointment.dxResizable('instance')) === null || _currentAppointment$d3 === void 0 ? void 0 : _currentAppointment$d3._toggleResizingClass(false);
        }
      }.bind(this),
      del: function (e) {
