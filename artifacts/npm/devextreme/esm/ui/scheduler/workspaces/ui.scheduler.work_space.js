...
class SchedulerWorkSpace extends WidgetObserver {
  ...
  _dateTableScrollableConfig() {
    var config = {
      ...
      onScroll: () => {
        ...
        (_this$_groupedStrateg = this._groupedStrategy.cache) === null || _this$_groupedStrateg === void 0 ? void 0 : _this$_groupedStrateg.clear();
      }
    };
  ...
  _attachDragEvents(element) {
    ...
    eventsEngine.on(element, DragEventNames.DROP, DRAG_AND_DROP_SELECTOR, () => {
      ...
      (_this$dragBehavior$dr = this.dragBehavior.dragBetweenComponentsPromise) === null || _this$dragBehavior$dr === void 0 ? void 0 : _this$dragBehavior$dr.then(() => {
        this.dragBehavior.removeDroppableClasses();
      });
    });
  }
  ...
  updateAppointments() {
    ...
    (_this$dragBehavior2 = this.dragBehavior) === null || _this$dragBehavior2 === void 0 ? void 0 : _this$dragBehavior2.updateDragSource();
  }
