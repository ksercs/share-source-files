...
import { map as _map, getLog, getCategoriesInfo, updatePanesCanvases, convertVisualRangeObject, PANE_PADDING, normalizePanesHeight, rangesAreEqual, isRelativeHeightPane, extractColor } from './core/utils';
  ...
  _applyAutoHidePointMarkers(filteredSeries) {
    ...
    for (var i = filteredSeries.length - 1; i >= 0; i--) {
      ...
      if (!currentSeries.autoHidePointMarkers) {
        ...
        var overlappingPointsCount = seriesPoints.reduce((pointsCount, currentPoint) => {
