...
ControlBar.prototype = {
  ...
  _createElements: function _createElements(renderer, container, dataKey) {
    ...
    var panControl = that._panControl = createVisibilityGroup(renderer, that._root, 'dxm-pan-control');
    var zoomBar = that._zoomBar = createVisibilityGroup(renderer, that._root, 'dxm-zoom-bar');
    var trackersPan = that._trackersPan = createTracker(renderer, that._root);
    var trackersZoom = that._trackersZoom = createTracker(renderer, that._root);
