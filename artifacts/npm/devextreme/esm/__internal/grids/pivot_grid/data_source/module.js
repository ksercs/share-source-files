...
import { foreachTree, foreachTreeAsync, findField, formatValue, createPath, setFieldProperty, getFieldsDataType, } from '../module_widget_utils';
            ...
            if (store) {
                ...
                when.apply(null, results).done(function () {
                    ...
                    for (let i = 0; i < results.length; i += 1) {
                        ...
                        if (options.path) {
                            that.applyPartialDataSource(options.area, options.path, data, isLast
                                ? deferred
                                : false, options.oppositePath);
                        }
