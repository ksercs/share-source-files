...
(["testing/tests/DevExpress.serverSide/widgetsCreation.tests.js"], ["../../helpers/widgetsList.js","data/data_source"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.serverSide/widgetsCreation.tests.js', ['../../helpers/widgetsList.js', 'data/data_source'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const widgets = $__require('../../helpers/widgetsList.js').widgetsList;

    const DataSource = $__require('data/data_source');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["../../helpers/widgetsList.js","data/data_source"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("../../helpers/widgetsList.js"), require("data/data_source"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=widgetsCreation.tests.js.map