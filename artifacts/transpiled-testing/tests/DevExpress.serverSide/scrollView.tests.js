...
(["testing/tests/DevExpress.serverSide/scrollView.tests.js"], ["jquery","ui/scroll_view"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.serverSide/scrollView.tests.js', ['jquery', 'ui/scroll_view'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');

    $__require('ui/scroll_view');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/scroll_view"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/scroll_view"));
  else
