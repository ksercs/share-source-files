System.register(["jquery", "core/utils/size", "core/utils/browser"], function (_export, _context) {
  "use strict";

  var $, sizeUtils, getHeight, getWidth, getInnerHeight, getInnerWidth, getOuterHeight, getOuterWidth, browser, testStyles, windowHeight;
  function getScrollbarThickness() {
    if (browser.mozilla) {
      return 0;
    }
    const scrollbarTest = $('<div>').css({
      width: '100px',
      height: '100px',
      overflow: 'scroll'
  ...
  function updateElementStyle(that, style) {
    that.$element = $('<div>').css(style).appendTo(that.$parent);
  }
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_coreUtilsSize) {
      sizeUtils = _coreUtilsSize.default;
      getHeight = _coreUtilsSize.getHeight;
      getWidth = _coreUtilsSize.getWidth;
      getInnerHeight = _coreUtilsSize.getInnerHeight;
      getInnerWidth = _coreUtilsSize.getInnerWidth;
      getOuterHeight = _coreUtilsSize.getOuterHeight;
