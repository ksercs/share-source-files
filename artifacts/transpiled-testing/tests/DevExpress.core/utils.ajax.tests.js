...
(["testing/tests/DevExpress.core/utils.ajax.tests.js"], ["jquery","core/utils/ajax","core/utils/version"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.core/utils.ajax.tests.js', ['jquery', 'core/utils/ajax', 'core/utils/version'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const ajax = $__require('core/utils/ajax');
    const compareVersion = $__require('core/utils/version').compare;
    ...
    QUnit.test('Accept headers for different dataTypes', function (assert) {
        const dataTypes = [{ type: '', header: '*/*' }, { type: 'someType', header: '*/*' }, { type: undefined, header: '*/*' }, { type: null, header: '*/*' }, { type: '*', header: '*/*' }, { type: 'text', header: 'text/plain, */*; q=0.01' }, { type: 'html', header: 'text/html, */*; q=0.01' }, { type: 'json', header: 'application/json, text/javascript, */*; q=0.01' }, { type: 'xml', header: 'application/xml, text/xml, */*; q=0.01' }, { type: 'script', header: 'text/javascript, application/javascript, application/ecmascript, application/x-ecmascript, */*; q=0.01' }, { type: 'jsonp', header: 'text/javascript, application/javascript, application/ecmascript, application/x-ecmascript, */*; q=0.01' }];
    ...
    QUnit.test('Post process of data with different dataType (same domain)', function (assert) {
        const result = [];
        const dataTypes = [{ type: 'json', response: '{ \'value\': 1234 }', result: undefined }, { type: 'json', response: '{ "value": 1234 }', result: { 'value': 1234 } }, { type: 'script', response: 'var variable = 10;', result: 'var variable = 10;' }, { type: 'text', response: 'text text', result: 'text text' }];
        let error;
        let status;
        let i;
    ...
    QUnit.test('X-Requested-With headers (no cors)', function (assert) {
        ...
        const testData = [{ url: './', crossDomain: false }, { url: '/some-url', crossDomain: false }, { url: location.origin + '/some-url', crossDomain: false }];
    ...
    QUnit.test('X-Requested-With headers (cors)', function (assert) {
        ...
        const testData = [{ url: 'http://example.com:80', crossDomain: true }, { url: 'http://example.com:80x', crossDomain: true }];
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/ajax","core/utils/version"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/ajax"), require("core/utils/version"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=utils.ajax.tests.js.map