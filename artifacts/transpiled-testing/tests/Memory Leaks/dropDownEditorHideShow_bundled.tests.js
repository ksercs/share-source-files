...
(["testing/tests/Memory Leaks/dropDownEditorHideShow_bundled.tests.js"], ["jquery","ui/drop_down_editor/ui.drop_down_editor","ui/map/provider.dynamic.google","../../helpers/memoryLeaksHelper.js","bundles/modules/parts/widgets-web"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/Memory Leaks/dropDownEditorHideShow_bundled.tests.js', ['jquery', 'ui/drop_down_editor/ui.drop_down_editor', 'ui/map/provider.dynamic.google', '../../helpers/memoryLeaksHelper.js', 'bundles/modules/parts/widgets-web'], true, function ($__require, exports, module) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/drop_down_editor/ui.drop_down_editor","ui/map/provider.dynamic.google","../../helpers/memoryLeaksHelper.js","bundles/modules/parts/widgets-web"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/drop_down_editor/ui.drop_down_editor"), require("ui/map/provider.dynamic.google"), require("../../helpers/memoryLeaksHelper.js"), require("bundles/modules/parts/widgets-web"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=dropDownEditorHideShow_bundled.tests.js.map