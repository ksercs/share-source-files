...
(["testing/tests/Memory Leaks/eventsOnDispose_bundled.tests.js"], ["jquery","ui/map/provider.dynamic.google","../../helpers/memoryLeaksHelper.js","bundles/modules/parts/widgets-web"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/Memory Leaks/eventsOnDispose_bundled.tests.js', ['jquery', 'ui/map/provider.dynamic.google', '../../helpers/memoryLeaksHelper.js', 'bundles/modules/parts/widgets-web'], true, function ($__require, exports, module) {
        ...
        if ($.fn[componentName] && memoryLeaksHelper.componentCanBeTriviallyInstantiated(componentName)) {
            QUnit.test(componentName + ' should not leak memory by not removing redundant event subscriptions after disposing', function (assert) {
                ...
                try {
                    ...
                    $(testNode)[componentName](memoryLeaksHelper.getComponentOptions(componentName))[componentName]('instance'), this.clock.tick(0);
...
//# sourceMappingURL=eventsOnDispose_bundled.tests.js.map