...
(["testing/tests/DevExpress.localization/localization.globalize.tests.js"], ["devextreme-cldr-data/ar.json!json","devextreme-cldr-data/ru.json!json","devextreme-cldr-data/de.json!json","devextreme-cldr-data/da.json!json","localization/globalize/core","localization/globalize/number","localization/globalize/currency","localization/globalize/date","localization/globalize/message","../../helpers/dateHelper.js","jquery","globalize","localization/number","localization/date","localization/message","core/config","../DevExpress.exporter/exceljsParts/exceljs.format.tests.js","cldr-core/supplemental/likelySubtags.json!","core/utils/common","format_helper","core/utils/browser","core/utils/date","./sharedParts/localization.shared.js"], true, function($__System) {
...
define("testing/tests/DevExpress.localization/localization.globalize.tests.js", ["require", "exports", "module", "devextreme-cldr-data/ar.json!json", "devextreme-cldr-data/ru.json!json", "devextreme-cldr-data/de.json!json", "devextreme-cldr-data/da.json!json", "localization/globalize/core", "localization/globalize/number", "localization/globalize/currency", "localization/globalize/date", "localization/globalize/message", "../../helpers/dateHelper.js", "jquery", "globalize", "localization/number", "localization/date", "localization/message", "core/config", "../DevExpress.exporter/exceljsParts/exceljs.format.tests.js", "cldr-core/supplemental/likelySubtags.json!", "core/utils/common", "format_helper", "core/utils/browser", "core/utils/date", "./sharedParts/localization.shared.js"], function(require, exports, module) {
  const cldrData = [require('devextreme-cldr-data/ar.json!json'), require('devextreme-cldr-data/ru.json!json'), require('devextreme-cldr-data/de.json!json'), require('devextreme-cldr-data/da.json!json')];
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["devextreme-cldr-data/ar.json!json","devextreme-cldr-data/ru.json!json","devextreme-cldr-data/de.json!json","devextreme-cldr-data/da.json!json","localization/globalize/core","localization/globalize/number","localization/globalize/currency","localization/globalize/date","localization/globalize/message","../../helpers/dateHelper.js","jquery","globalize","localization/number","localization/date","localization/message","core/config","../DevExpress.exporter/exceljsParts/exceljs.format.tests.js","cldr-core/supplemental/likelySubtags.json!","core/utils/common","format_helper","core/utils/browser","core/utils/date","./sharedParts/localization.shared.js"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("devextreme-cldr-data/ar.json!json"), require("devextreme-cldr-data/ru.json!json"), require("devextreme-cldr-data/de.json!json"), require("devextreme-cldr-data/da.json!json"), require("localization/globalize/core"), require("localization/globalize/number"), require("localization/globalize/currency"), require("localization/globalize/date"), require("localization/globalize/message"), require("../../helpers/dateHelper.js"), require("jquery"), require("globalize"), require("localization/number"), require("localization/date"), require("localization/message"), require("core/config"), require("../DevExpress.exporter/exceljsParts/exceljs.format.tests.js"), require("cldr-core/supplemental/likelySubtags.json!"), require("core/utils/common"), require("format_helper"), require("core/utils/browser"), require("core/utils/date"), require("./sharedParts/localization.shared.js"));
  else
