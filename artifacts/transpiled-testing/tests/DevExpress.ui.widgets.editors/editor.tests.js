...
(["testing/tests/DevExpress.ui.widgets.editors/editor.tests.js"], ["jquery","core/component","ui/editor/editor","renovation/ui/editors/common/editor.j","core/class","ui/validation_engine","events/hover","../../helpers/wrapRenovatedWidget.js","ui/validator","core/utils/size","generic_light.css!"], false, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.register("testing/tests/DevExpress.ui.widgets.editors/editor.tests.js", ["jquery", "core/component", "ui/editor/editor", "renovation/ui/editors/common/editor.j", "core/class", "ui/validation_engine", "events/hover", "../../helpers/wrapRenovatedWidget.js", "ui/validator", "core/utils/size", "generic_light.css!"], function($__export) {
  "use strict";
  var $,
      Component,
      OldEditor,
  ...
  return {
    setters: [function($__m) {
      ...
      OldEditor = $__m.default;
    }, function($__m) {
      NewEditor = $__m.default;
    }, function($__m) {
      Class = $__m.default;
    }, function($__m) {
      ValidationEngine = $__m.default;
    }, function($__m) {
      hoverEvents = $__m.default;
    }, function($__m) {
      wrapRenovatedWidget = $__m.wrapRenovatedWidget;
    }, function($__m) {
    ...
    execute: function() {
      wrapRenovatedEditor = function(editor) {
        var wrapperEditor = wrapRenovatedWidget(editor);
        wrapperEditor.isEditor = editor.isEditor;
        return wrapperEditor;
      };
      Editor = QUnit.urlParams.norenovation ? OldEditor : wrapRenovatedEditor(NewEditor);
      ...
      skipForRenovated = function(name, testCallback) {
      ...
      QUnit.module('base', moduleConfig, function() {
      ...
      QUnit.module('readOnly', moduleConfig, function() {
        ...
        skipForRenovated('prevent backspace event when editor is readonly', function() {
          [false, true].forEach(function(readOnly) {
            QUnit.module('"backspace" key press event', {beforeEach: function() {
                this.editor = this.fixture.createEditor({readOnly: readOnly});
                this.$eventTarget = $(this.editor.$element());
                this.event = $.Event('keydown', {key: 'Backspace'});
              }}, function() {
              var isReadOnly = readOnly ? '' : 'not';
              ...
              var becomesReadOnly = readOnly ? 'not' : '';
      ...
      QUnit.module('methods', moduleConfig, function() {
        ...
        QUnit.testInActiveWindow('The blur() method does not blur the active item', function(assert) {
          ...
          var editor = this.fixture.createEditor({value: '123'});
          var $testElement = $('<input type="button">');
      ...
      QUnit.module('value option', moduleConfig, function() {
        [{}, {readOnly: true}, {disabled: true}].forEach(function(initialConfig) {
          QUnit.test(("value change triggers valueChanged event with correct parameters, " + JSON.stringify(initialConfig)), function(assert) {
            ...
            var $__3 = valueChangedStub.getCall(0).args[0],
        ...
        QUnit.test('onValueChanged should work correctly when it is passed on onInitialized (T314007)', function(assert) {
          var valueChangedStub = sinon.stub();
          var editor = this.fixture.createEditor({onInitialized: function(e) {
      ...
      QUnit.module('validation', {
        beforeEach: function() {
          ...
          this.getValidationMessage = function() {
            return $__2.editor.$element().find(("." + INVALID_MESSAGE_CLASS)).eq(0).dxValidationMessage().dxValidationMessage('instance');
          };
          this.getValidationMessageElement = function() {
            return $__2.getValidationMessage().$element();
          };
          this.reinitEditor = function() {
            var options = arguments[0] !== (void 0) ? arguments[0] : {};
            $__2.editor.dispose();
            $__2.editor = $__2.fixture.createEditor(options);
          };
          this.editor = this.fixture.createEditor({
            isValid: false,
            validationError: {message: this.message}
          });
        },
        afterEach: function() {
          this.fixture.teardown();
        ...
        QUnit.test('validator integration', function(assert) {
          ...
          new Validator(this.editor.$element(), {validationRules: [{
              type: 'required',
              message: 'required'
            }]});
        ...
        QUnit.module('validation message', function() {
          ...
          QUnit.module('options', function() {
            ...
            QUnit.test('validationMessage should be updated after validationError option runtime change', function(assert) {
              this.reinitEditor({
                isValid: true,
                validationError: {message: '1'},
                validationStatus: 'invalid'
              });
              this.editor.option({validationError: {message: '2'}});
              var message = this.getValidationMessage().$content().text();
            ...
            QUnit.test('validationMessage should have correct position from validationMessagePosition on init', function(assert) {
              ...
              var position = this.getValidationMessage().option('positionSide');
            ...
            if (!Editor.IS_RENOVATED_WIDGET) {
              QUnit.test('editor should clear validation message cache on dispose (T968422)', function(assert) {
                assert.expect(0);
                var TestEditor = function($__super) {
                  function TestEditor() {
                    $traceurRuntime.superConstructor(TestEditor).apply(this, arguments);
                  }
                  return ($traceurRuntime.createClass)(TestEditor, {repaintValidationMessage: function() {
                      this._validationMessage && this._validationMessage.repaint();
                      this._$validationMessage && this._$validationMessage.dxValidationMessage('instance').repaint();
                    }}, {}, $__super);
                }(Editor);
                var $element = this.fixture.createOnlyElement();
                var instance = new TestEditor($element, {
                  validationMessageMode: 'always',
            ...
            skipForRenovated('private validationTooltipOptions, validationBoundary, validationMessageOffset', function() {
              QUnit.module('private options sync', function() {
                QUnit.test('boundary should be updated after editor validationBoundary runtime change', function(assert) {
                  var $boundary = this.fixture.createOnlyElement().css({paddingTop: '100px'});
                  var validationMessage = this.getValidationMessage();
                ...
                QUnit.test('it should be possible to set null or undefined to the validationTooltipOptions', function(assert) {
                  ...
                  this.editor.option('validationTooltipOptions', {
                    test2: null,
                    test: undefined
                  });
          ...
          QUnit.module('width', function() {
            QUnit.test('should be equal to editor width', function(assert) {
              var width = 100;
              this.reinitEditor({
                width: 100,
                validationMessageMode: 'always',
                validationError: {message: 'Flip'},
                isValid: false
              });
              var $validationMessage = this.getValidationMessageElement();
            ...
            QUnit.test('should be correct for small content', function(assert) {
              ...
              var $content = this.getValidationMessage().$content();
              var contentWidth = getOuterWidth($content);
            ...
            QUnit.test('should be min 100px if the editor has smaller size (T376114)', function(assert) {
              this.reinitEditor({
                width: 20,
                validationMessageMode: 'always',
                validationError: {message: 'ErrorErrorErrorErrorErrorErrorError'},
                isValid: false
              });
              var $content = this.getValidationMessage().$content();
            ...
            QUnit.test('content width should be less or equal to message width', function(assert) {
              this.reinitEditor({
                width: 100,
                validationMessageMode: 'always',
                validationError: {message: 'Very very very very very very very very very very very very very very very very very long validation message'},
                isValid: false
              });
              var validationMessage = this.getValidationMessage();
              var $validationMessage = validationMessage.$content();
              var $content = validationMessage.$content();
              assert.ok(getOuterWidth($content) <= getOuterWidth($validationMessage), 'validation message width is correct');
            });
            skipForRenovated('update validation message maxWidth on editor width change', function() {
              QUnit.test('max width should be updated after editor width runtime change', function(assert) {
                this.reinitEditor({
                  width: 20,
                  validationMessageMode: 'always',
                  validationError: {message: 'This_message_width_more_than_max_set_width'},
                  isValid: false
                });
          ...
          QUnit.test('should flip if it is out of validationBoundary', function(assert) {
            var $parent = this.fixture.createOnlyElement().css({paddingTop: '100px'});
          ...
          QUnit.test('should be rendered correctly in hidden area', function(assert) {
            var $element = this.fixture.createOnlyElement();
            var $hiddenDiv = this.fixture.createOnlyElement().css('display', 'none');
            $element.appendTo($hiddenDiv);
        ...
        QUnit.module('aria-describedby attribute', function() {
          ...
          QUnit.test('should not be updated after option change without validation state change', function(assert) {
            ...
            var describedBy = $editor.attr('aria-describedby');
          ...
          QUnit.test('should be correct after repaint', function(assert) {
            var $editor = this.editor.$element();
            this.editor.repaint();
            var validationMessageContentId = this.getValidationMessage().$content().attr('id');
      ...
      QUnit.module('aria accessibility', moduleConfig, function() {
        var expectedFalseValue = Editor.IS_RENOVATED_WIDGET ? 'false' : undefined;
        ...
        QUnit.test('invalid state', function(assert) {
          ...
          var $editor = editor.$element();
          var messageId = $editor.find(("." + INVALID_MESSAGE_CLASS)).dxValidationMessage().dxValidationMessage('instance').$content().attr('id');
        ...
        QUnit.test('"onMarkupRendered" is called after markup render (for validator integration)', function(assert) {
          var markupRenderedStub = sinon.stub();
          this.fixture.createEditor({_onMarkupRendered: markupRenderedStub});
          assert.ok(markupRenderedStub.calledOnce);
        });
      });
      QUnit.module('private api', moduleConfig, function() {
        if (!Editor.IS_RENOVATED_WIDGET) {
        ...
        QUnit.test('If _valueChangeEventInstance is present, the onValueChanged must receive it as a Event argument and then _valueChangeEventInstance must be reset', function(assert) {
          var newValue = 'new';
          var _valueChangeEventInstance = 'something';
          var onValueChanged = function(options) {
        ...
        skipForRenovated('private: _suppressValueChangeAction, _resumeValueChangeAction', function() {
      ...
      QUnit.module('validationRequest', moduleConfig, function() {
        QUnit.test('should fire on value change', function(assert) {
          var value = 'test123';
          var handler = sinon.stub();
          var editor = this.fixture.createEditor({value: 'xxx'});
        ...
        QUnit.test('should NOT fire on value change from undefined to null (T220137)', function(assert) {
          var handler = sinon.stub();
          var editor = this.fixture.createEditor({value: undefined});
          editor.validationRequest.add(handler);
        ...
        QUnit.test('should fire before valueChanged callback', function(assert) {
          var editor = this.fixture.createEditor({
            ...
            onValueChanged: function($__3) {
              var $__4 = $__3,
                  value = $__4.value,
                  previousValue = $__4.previousValue;
          ...
          editor.validationRequest.add(function($__3) {
            var value = $__3.value;
            assert.step(("Validate value: \"" + value + "\""));
          });
          editor.option('value', 'test');
          assert.verifySteps(['Validate value: "test"', 'Value changed from "empty" to "test"', 'Validate value: "TEST"', 'Value changed from "test" to "TEST"']);
        });
      });
      if (!Editor.IS_RENOVATED_WIDGET) {
        QUnit.test('keybord navigation should work after editor becomes not read only', function(assert) {
          ...
          var keyboardHandledStub = sinon.stub();
          var editor = new Editor($element, {
        ...
        QUnit.module('"name" option', {
          ...
          QUnit.test('editor inheritor input should get the "name" attribute with a correct value', function(assert) {
            ...
            new this.EditorInheritor(this.$element, {name: expectedName});
          ...
          QUnit.test('editor inheritor input should get correct "name" attribute after the "name" option is changed', function(assert) {
            ...
            var instance = new this.EditorInheritor(this.$element, {name: 'initial_name'});
            var $input = this.$element.find('input[type="hidden"]');
          ...
          QUnit.test('the "name" attribute should be removed after name is changed to an empty string', function(assert) {
            var instance = new this.EditorInheritor(this.$element, {name: 'some_name'});
            var input = this.$element.find('input[type="hidden"]').get(0);
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/component","ui/editor/editor","renovation/ui/editors/common/editor.j","core/class","ui/validation_engine","events/hover","../../helpers/wrapRenovatedWidget.js","ui/validator","core/utils/size","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/component"), require("ui/editor/editor"), require("renovation/ui/editors/common/editor.j"), require("core/class"), require("ui/validation_engine"), require("events/hover"), require("../../helpers/wrapRenovatedWidget.js"), require("ui/validator"), require("core/utils/size"), require("generic_light.css!"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=editor.tests.js.map