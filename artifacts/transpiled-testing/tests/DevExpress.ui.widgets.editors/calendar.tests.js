System.register(["jquery", "core/utils/inflector", "animation/translator", "core/utils/date", "core/utils/date_serialization", "core/utils/common", "events/swipe", "animation/fx", "ui/calendar/ui.calendar.views", "ui/calendar", "../../helpers/pointerMock.js", "../../helpers/keyboardMock.js", "core/config", "core/element_data", "core/devices.js", "localization/date", "events/utils/index", "localization", "generic_light.css!"], function (_export, _context) {
  "use strict";

  var $, camelize, translator, dateUtils, dateSerialization, noop, swipeEvents, fx, Views, Calendar, pointerMock, keyboardMock, config, dataUtils, devices, dateLocalization, normalizeKeyName, localization, CALENDAR_BODY_CLASS, CALENDAR_CELL_CLASS, CALENDAR_WEEK_NUMBER_CELL_CLASS, CALENDAR_DISABLED_NAVIGATOR_LINK_CLASS, CALENDAR_NAVIGATOR_NEXT_MONTH_CLASS, CALENDAR_NAVIGATOR_PREVIOUS_VIEW_CLASS, CALENDAR_NAVIGATOR_NEXT_VIEW_CLASS, CALENDAR_TODAY_BUTTON_CLASS, CALENDAR_CAPTION_BUTTON_CLASS, CALENDAR_OTHER_VIEW_CLASS, CALENDAR_VIEWS_WRAPPER_CLASS, CALENDAR_SELECTED_DATE_CLASS, CALENDAR_CELL_IN_RANGE_CLASS, CALENDAR_RANGE_START_DATE_CLASS, CALENDAR_RANGE_END_DATE_CLASS, CALENDAR_CONTOURED_DATE_CLASS, CALENDAR_DATE_VALUE_KEY, VIEW_ANIMATION_DURATION, ACTIVE_STATE_CLASS, ENTER_KEY_CODE, PAGE_UP_KEY_CODE, PAGE_DOWN_KEY_CODE, END_KEY_CODE, HOME_KEY_CODE, LEFT_ARROW_KEY_CODE, UP_ARROW_KEY_CODE, RIGHT_ARROW_KEY_CODE, DOWN_ARROW_KEY_CODE, getShortDate, getBeforeViewInstance, getCurrentViewInstance, getAdditionalViewInstance, getAfterViewInstance, toSelector, iterateViews, commandKeysConfigs;
  ...
  return {
    setters: [function (_jquery) {
      $ = _jquery.default;
    }, function (_coreUtilsInflector) {
      camelize = _coreUtilsInflector.camelize;
    }, function (_animationTranslator) {
      translator = _animationTranslator.default;
    }, function (_coreUtilsDate) {
      dateUtils = _coreUtilsDate.default;
    }, function (_coreUtilsDate_serialization) {
      dateSerialization = _coreUtilsDate_serialization.default;
    }, function (_coreUtilsCommon) {
      noop = _coreUtilsCommon.noop;
    }, function (_eventsSwipe) {
      swipeEvents = _eventsSwipe.default;
    }, function (_animationFx) {
      fx = _animationFx.default;
    }, function (_uiCalendarUiCalendarViews) {
      Views = _uiCalendarUiCalendarViews.default;
    }, function (_uiCalendar) {
      Calendar = _uiCalendar.default;
    }, function (_helpersPointerMockJs) {
      pointerMock = _helpersPointerMockJs.default;
    }, function (_helpersKeyboardMockJs) {
      keyboardMock = _helpersKeyboardMockJs.default;
    }, function (_coreConfig) {
      config = _coreConfig.default;
    }, function (_coreElement_data) {
      dataUtils = _coreElement_data.default;
    }, function (_coreDevicesJs) {
      devices = _coreDevicesJs.default;
    }, function (_localizationDate) {
      dateLocalization = _localizationDate.default;
    }, function (_eventsUtilsIndex) {
      normalizeKeyName = _eventsUtilsIndex.normalizeKeyName;
    }, function (_localization) {
      localization = _localization.default;
    }, function (_generic_lightCss) {}],
    execute: function () {
      // calendar
      ...
      CALENDAR_VIEWS_WRAPPER_CLASS = 'dx-calendar-views-wrapper'; // calendar view
      CALENDAR_SELECTED_DATE_CLASS = 'dx-calendar-selected-date';
      CALENDAR_CELL_IN_RANGE_CLASS = 'dx-calendar-cell-in-range';
      CALENDAR_RANGE_START_DATE_CLASS = 'dx-calendar-range-start-date';
      CALENDAR_RANGE_END_DATE_CLASS = 'dx-calendar-range-end-date';
      ...
      getBeforeViewInstance = calendar => {
        return calendar._beforeView;
      };
      getCurrentViewInstance = calendar => {
        return calendar._view;
      };
      getAdditionalViewInstance = calendar => {
        return calendar._additionalView;
      };
      getAfterViewInstance = calendar => {
        return calendar._afterView;
      };
      toSelector = className => {
        return '.' + className;
      };
      iterateViews = callback => {
      ...
      QUnit.module('Keyboard navigation', {
        ...
        QUnit.test('left/right key press should change currentDate correctly', function (assert) {
          const params = {
            'month': {
              startDate: new Date(2013, 9, 13),
              movedDate: new Date(2013, 9, 14)
            },
            'year': {
              startDate: new Date(2013, 9, 13),
              movedDate: new Date(2013, 10, 13)
            },
            'decade': {
              startDate: new Date(2013, 9, 13),
              movedDate: new Date(2014, 9, 13)
            },
            'century': {
              startDate: new Date(2013, 9, 13),
              movedDate: new Date(2023, 9, 13)
            }
          };
        ...
        QUnit.test('left/right key press should change currentDate correctly in RTL', function (assert) {
          ...
          const params = {
            'month': {
              ...
              movedDate: new Date(2023, 9, 12)
            },
            'year': {
              startDate: new Date(2023, 9, 13),
              movedDate: new Date(2023, 8, 13)
            },
            'decade': {
              startDate: new Date(2023, 9, 13),
              movedDate: new Date(2022, 9, 13)
            },
            'century': {
              startDate: new Date(2023, 9, 13),
              movedDate: new Date(2013, 9, 13)
            }
          };
          const keyboard = keyboardMock(this.$element);
          const calendar = this.calendar;
        ...
        QUnit.test('home/end keypress must contoured first and last allowable cells', function (assert) {
          const params = {
            'month': {
              value: new Date(2010, 10, 15),
              min: new Date(2010, 10, 5),
              max: new Date(2010, 10, 24)
            },
            'year': {
              value: new Date(2015, 4, 10),
              min: new Date(2015, 2, 18),
              max: new Date(2015, 8, 18)
            },
            'decade': {
              value: new Date(2015, 10, 15),
              min: new Date(2013, 2, 18),
              max: new Date(2018, 6, 18)
            },
            'century': {
              value: new Date(2045, 10, 15),
              min: new Date(2030, 2, 18),
              max: new Date(2075, 6, 18)
            }
          };
        ...
        QUnit.test('keydown event default behavior should be prevented by calendar keydown handlers for datebox integration', function (assert) {
          ...
          this.$element.on('keydown.TEST', e => {
            assert.ok(e.isDefaultPrevented());
          }).trigger($.Event('keydown', {
            key: LEFT_ARROW_KEY_CODE
          })).trigger($.Event('keydown', {
            key: UP_ARROW_KEY_CODE
          })).trigger($.Event('keydown', {
            key: RIGHT_ARROW_KEY_CODE
          })).trigger($.Event('keydown', {
            key: DOWN_ARROW_KEY_CODE
          })).off('.TEST');
        });
      ...
      QUnit.module('Options', {
        ...
        [{
          localeID: 'de',
          expectedFirstDayOfWeek: 'Montag'
        }, {
          localeID: 'en',
          expectedFirstDayOfWeek: 'Sunday'
        }, {
          localeID: 'ja',
          expectedFirstDayOfWeek: '日曜日'
        },
        // eslint-disable-next-line i18n/no-russian-character
        {
          localeID: 'ru',
          expectedFirstDayOfWeek: 'понедельник'
        }, {
          localeID: 'zh',
          expectedFirstDayOfWeek: '星期日'
        }, {
          localeID: 'hr',
          expectedFirstDayOfWeek: 'ponedjeljak'
        }, {
          localeID: 'ar',
          expectedFirstDayOfWeek: 'السبت'
        }, {
          localeID: 'el',
          expectedFirstDayOfWeek: 'Δευτέρα'
        }, {
          localeID: 'ca',
          expectedFirstDayOfWeek: 'dilluns'
        }].forEach(({
          localeID,
        ...
        QUnit.module('SelectionMode', {
          ...
          QUnit.module('Range', {
            ...
            [[null, null], [new Date(2021, 9, 17), null], [null, new Date(2021, 10, 25)], [new Date(2021, 9, 10), new Date(2021, 9, 17)]].forEach(values => {
      ...
      QUnit.module('Min & Max options', {
        ...
        QUnit.test('correct views rendering with min option', function (assert) {
          const params = {
            'year': {
              value: new Date(2015, 0, 8),
              min: new Date(2014, 11, 16)
            },
            'decade': {
              value: new Date(2010, 0, 8),
              min: new Date(2009, 11, 16)
            },
            'century': {
              value: new Date(2000, 0, 8),
              min: new Date(1999, 11, 16)
            }
          };
        ...
        QUnit.test('correct views rendering with max option', function (assert) {
          const params = {
            'year': {
              value: new Date(2015, 11, 8),
              max: new Date(2016, 0, 16)
            },
            'decade': {
              value: new Date(2019, 11, 8),
              max: new Date(2020, 0, 16)
            },
            'century': {
              value: new Date(2099, 11, 8),
              max: new Date(2100, 0, 16)
            }
          };
          $.each(['year', 'decade', 'century'], $.proxy((_, type) => {
            this.reinit($.extend({}, params[type], {
      ...
      QUnit.module('Current date', {
        ...
        QUnit.test('current date is correct when trying to navigate out of available range', function (assert) {
          const params = {
            'month': {
              min: new Date(2015, 2, 14),
              max: new Date(2015, 2, 16),
              currentDate: new Date(2015, 2, 15)
            },
            'year': {
              min: new Date(2015, 1, 17),
              max: new Date(2015, 3, 20),
              currentDate: new Date(2015, 2, 15)
            },
            'decade': {
              min: new Date(2014, 1, 17),
              max: new Date(2016, 3, 20),
              currentDate: new Date(2015, 2, 15)
            },
            'century': {
              min: new Date(2005, 1, 17),
        ...
        QUnit.test('after pressing upArrow/downArrow button the current view should be changed and the contouredDate should be set correctly', function (assert) {
          const params = {
            'month': {
              ...
              expectedDate: new Date(2015, 1, 24)
            },
            'year': {
              startDate: new Date(2015, 2, 1),
              expectedDate: new Date(2014, 10, 1)
            },
            'decade': {
              startDate: new Date(2010, 0, 1),
              expectedDate: new Date(2006, 0, 1)
            },
            'century': {
              startDate: new Date(2015, 0, 1),
              expectedDate: new Date(1975, 0, 1)
            }
          };
          iterateViews($.proxy((_, type) => {
            this.reinit();
      ...
      [1, 2].forEach(viewsCount => {
        QUnit.module(`Navigation - swiping (viewsCount=${viewsCount})`, {
          ...
          QUnit.test('performing a micro-swipe should not make the calendar jump by navigating to the same month', function (assert) {
            const swipeEnd = $.Event(swipeEvents.end, {
              offset: 0,
              targetOffset: 0
            });
            this.calendar._navigate = () => {
      ...
      QUnit.module('dxCalendar number and string value support', {
        ...
        QUnit.test('new cell selection should change value correct if the value type is string', function (assert) {
          ...
          this.$element.find('.' + CALENDAR_SELECTED_DATE_CLASS).next('.' + CALENDAR_CELL_CLASS).trigger('dxclick');
        ...
        QUnit.module(`valueChanged handler should receive correct event (selectionMode = ${selectionMode}`, {
          beforeEach: function () {
            ...
            this.checkEvent = (assert, type, target, key) => {
              ...
              if (type === 'keydown') {
                assert.strictEqual(normalizeKeyName(event), normalizeKeyName({
                  key
                }), 'event key is correct');
              }
            };
          },
          afterEach: function () {
