...
(["testing/tests/DevExpress.knockout/tagBox.tests.js"], ["jquery","ui/tag_box","animation/fx","knockout","integration/knockout"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/tagBox.tests.js', ['jquery', 'ui/tag_box', 'animation/fx', 'knockout', 'integration/knockout'], true, function ($__require, exports, module) {
    ...
    QUnit.testStart(function () {
        const markup = '<div id="tagBoxWithFieldTemplate" data-bind="dxTagBox: { dataSource: dataSource, fieldTemplate: \'field\', valueExpr: \'key\', value: value }">\
    ...
    QUnit.test('fieldTemplate is bound to selected items', function (assert) {
        const viewModel = {
            dataSource: [{ key: 1, name: 'one' }, { key: 2, name: 'two' }, { key: 3, name: 'three' }],
            value: [1, 2]
        };
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/tag_box","animation/fx","knockout","integration/knockout"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/tag_box"), require("animation/fx"), require("knockout"), require("integration/knockout"));
  else
