...
(["testing/tests/DevExpress.knockout/scheduler.tests.js"], ["jquery","knockout","integration/knockout","ui/scheduler","generic_light.css!"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/scheduler.tests.js', ['jquery', 'knockout', 'integration/knockout', 'ui/scheduler', 'generic_light.css!'], true, function ($__require, exports, module) {
    ...
    const Scheduler = $__require('ui/scheduler');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","knockout","integration/knockout","ui/scheduler","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("knockout"), require("integration/knockout"), require("ui/scheduler"), require("generic_light.css!"));
  else
