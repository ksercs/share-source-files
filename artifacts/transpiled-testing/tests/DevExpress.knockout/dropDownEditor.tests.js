...
(["testing/tests/DevExpress.knockout/dropDownEditor.tests.js"], ["jquery","knockout","integration/knockout","ui/drop_down_editor/ui.drop_down_editor"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/dropDownEditor.tests.js', ['jquery', 'knockout', 'integration/knockout', 'ui/drop_down_editor/ui.drop_down_editor'], true, function ($__require, exports, module) {
    ...
    $__require('ui/drop_down_editor/ui.drop_down_editor');

    const moduleWithoutCsp = QUnit.urlParams['nocsp'] ? QUnit.module : QUnit.module.skip;

    QUnit.testStart(function () {
        const markup = '<div id="dropDownEditorWithFieldTemplate" data-bind="dxDropDownEditor: { fieldTemplate: \'field\', value: \'test\'}">\
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","knockout","integration/knockout","ui/drop_down_editor/ui.drop_down_editor"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("knockout"), require("integration/knockout"), require("ui/drop_down_editor/ui.drop_down_editor"));
  else
