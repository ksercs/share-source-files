...
(["testing/tests/DevExpress.knockout/box.tests.js"], ["jquery","knockout","ui/box","integration/knockout"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/box.tests.js', ['jquery', 'knockout', 'ui/box', 'integration/knockout'], true, function ($__require, exports, module) {
    ...
    QUnit.testStart(function () {
        const markup = '<div id="nestedBox" data-bind="dxBox: {}">\
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","knockout","ui/box","integration/knockout"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("knockout"), require("ui/box"), require("integration/knockout"));
  else
