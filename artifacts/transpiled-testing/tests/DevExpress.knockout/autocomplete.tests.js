...
(["testing/tests/DevExpress.knockout/autocomplete.tests.js"], ["jquery","../../helpers/keyboardMock.js","knockout","ui/autocomplete","integration/knockout"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/autocomplete.tests.js', ['jquery', '../../helpers/keyboardMock.js', 'knockout', 'ui/autocomplete', 'integration/knockout'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const keyboardMock = $__require('../../helpers/keyboardMock.js');
    const ko = $__require('knockout');
    const Autocomplete = $__require('ui/autocomplete');
    ...
    QUnit.testStart(function () {
        const markup = '<div id="T131530" data-bind="dxAutocomplete: { items: [{}, {}], itemTemplate: \'item\', searchTimeout: 0 }">\
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","../../helpers/keyboardMock.js","knockout","ui/autocomplete","integration/knockout"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("../../helpers/keyboardMock.js"), require("knockout"), require("ui/autocomplete"), require("integration/knockout"));
  else
