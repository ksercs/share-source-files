...
(["testing/tests/DevExpress.knockout/tabs.tests.js"], ["jquery","knockout","ui/tabs","integration/knockout"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/tabs.tests.js', ['jquery', 'knockout', 'ui/tabs', 'integration/knockout'], true, function ($__require, exports, module) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","knockout","ui/tabs","integration/knockout"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("knockout"), require("ui/tabs"), require("integration/knockout"));
  else
