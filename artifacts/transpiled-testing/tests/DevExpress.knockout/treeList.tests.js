...
(["testing/tests/DevExpress.knockout/treeList.tests.js"], ["jquery","knockout","ui/tree_list","integration/knockout"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/treeList.tests.js', ['jquery', 'knockout', 'ui/tree_list', 'integration/knockout'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const ko = $__require('knockout');

    $__require('ui/tree_list');
    ...
    const testArray = [{ Id: 1, Head_ID: 0, Name: 'Name1' }, { Id: 2, Head_ID: 1, Name: 'Name2' }, { Id: 3, Head_ID: 1, Name: 'Name3' }, { Id: 4, Head_ID: 2, Name: 'Name4' }, { Id: 5, Head_ID: 2, Name: 'Name5' }, { Id: 6, Head_ID: 3, Name: 'Name6' }, { Id: 7, Head_ID: 3, Name: 'Name7' }];

    QUnit.testStart(function () {
        const markup = '<div id="testContainer">\
    ...
    QUnit.test('Two-way binding works well with the \'expandedRowKeys\' option', function (assert) {
        ...
        $testContainer.find('.dx-treelist-collapsed').first().trigger('dxclick');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","knockout","ui/tree_list","integration/knockout"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("knockout"), require("ui/tree_list"), require("integration/knockout"));
  else
