...
(["testing/tests/DevExpress.knockout/calendar.tests.js"], ["jquery","knockout","integration/knockout","ui/calendar"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/calendar.tests.js', ['jquery', 'knockout', 'integration/knockout', 'ui/calendar'], true, function ($__require, exports, module) {
    ...
    QUnit.testStart(function () {
        const markup = '<div id="T354951" data-bind="dxCalendar: {}">\
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","knockout","integration/knockout","ui/calendar"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("knockout"), require("integration/knockout"), require("ui/calendar"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=calendar.tests.js.map