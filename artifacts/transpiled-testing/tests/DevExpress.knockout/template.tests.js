...
(["testing/tests/DevExpress.knockout/template.tests.js"], ["jquery","core/utils/common","knockout","integration/knockout/template"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/template.tests.js', ['jquery', 'core/utils/common', 'knockout', 'integration/knockout/template'], true, function ($__require, exports, module) {
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","knockout","integration/knockout/template"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("knockout"), require("integration/knockout/template"));
  else
