...
(["testing/tests/DevExpress.knockout/overlay.tests.js"], ["jquery","animation/fx","knockout","ui/overlay/ui.overlay","ui/slider","integration/knockout","generic_light.css!"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/overlay.tests.js', ['jquery', 'animation/fx', 'knockout', 'ui/overlay/ui.overlay', 'ui/slider', 'integration/knockout', 'generic_light.css!'], true, function ($__require, exports, module) {
    ...
    $__require('ui/overlay/ui.overlay');
    $__require('ui/slider');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","animation/fx","knockout","ui/overlay/ui.overlay","ui/slider","integration/knockout","generic_light.css!"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("animation/fx"), require("knockout"), require("ui/overlay/ui.overlay"), require("ui/slider"), require("integration/knockout"), require("generic_light.css!"));
  else
