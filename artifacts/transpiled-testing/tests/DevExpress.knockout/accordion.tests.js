...
(["testing/tests/DevExpress.knockout/accordion.tests.js"], ["jquery","knockout","ui/accordion","integration/knockout"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/accordion.tests.js', ['jquery', 'knockout', 'ui/accordion', 'integration/knockout'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const ko = $__require('knockout');

    $__require('ui/accordion');
    ...
    QUnit.testStart(function () {
        const markup = '<div id="templated-accordion" data-bind="dxAccordion: {\
                items: [\
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","knockout","ui/accordion","integration/knockout"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("knockout"), require("ui/accordion"), require("integration/knockout"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=accordion.tests.js.map