...
(["testing/tests/DevExpress.knockout/actionSheet.tests.js"], ["jquery","core/utils/common","knockout","ui/action_sheet","integration/knockout"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/actionSheet.tests.js', ['jquery', 'core/utils/common', 'knockout', 'ui/action_sheet', 'integration/knockout'], true, function ($__require, exports, module) {
    ...
    QUnit.testStart(function () {
        const markup = '<div id="testItemTemplate">\
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","core/utils/common","knockout","ui/action_sheet","integration/knockout"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("core/utils/common"), require("knockout"), require("ui/action_sheet"), require("integration/knockout"));
  else
