...
(["testing/tests/DevExpress.knockout/lookup.tests.js"], ["jquery","animation/fx","../../helpers/executeAsyncMock.js","knockout","ui/lookup","integration/knockout"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/DevExpress.knockout/lookup.tests.js', ['jquery', 'animation/fx', '../../helpers/executeAsyncMock.js', 'knockout', 'ui/lookup', 'integration/knockout'], true, function ($__require, exports, module) {
    ...
    QUnit.testStart(function () {
        const markup = '<div id="T131530" data-bind="dxLookup: { items: [{ }, { }], itemTemplate: \'item\' }">\
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","animation/fx","../../helpers/executeAsyncMock.js","knockout","ui/lookup","integration/knockout"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("animation/fx"), require("../../helpers/executeAsyncMock.js"), require("knockout"), require("ui/lookup"), require("integration/knockout"));
  else
