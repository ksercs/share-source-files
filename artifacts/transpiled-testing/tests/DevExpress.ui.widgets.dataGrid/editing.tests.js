System.register(["animation/fx", "core/config", "core/devices", "core/element_data", "core/renderer", "core/utils/browser", "core/utils/common", "core/utils/deferred", "core/utils/size", "core/utils/type", "core/utils/shadow_dom", "events/core/events_engine", "events/pointer", "events/visibility_change", "generic_light.css!", "jquery", "ui/autocomplete", "ui/color_box", "ui/tag_box", "ui/data_grid", "ui/drop_down_box", "ui/drop_down_button", "ui/switch", "ui/validator", "ui/widget/ui.errors", "../../helpers/dataGridMocks.js", "../../helpers/pointerMock.js", "../../helpers/wrappers/dataGridWrappers.js", "../../helpers/dataGridHelper.js", "data/data_source/data_source"], function (_export, _context) {
  "use strict";

  var fx, config, devices, dataUtils, renderer, browser, commonUtils, Deferred, getHeight, getWidth, setWidth, getOffset, typeUtils, addShadowDomStyles, eventsEngine, pointerEvents, triggerResizeEvent, $, errors, getCells, generateItems, MockColumnsController, MockDataController, setupDataGridModules, pointerMock, DataGridWrapper, findShadowHostOrDocument, DataSource, device, dataGridWrapper, DIALOG_ANIMATION_TIMEOUT, generateDataSource;
  function getInputElements($container) {
    return $container.find('input:not([type=\'hidden\'])');
  }
  return {
    setters: [function (_animationFx) {
      fx = _animationFx.default;
    }, function (_coreConfig) {
      config = _coreConfig.default;
    }, function (_coreDevices) {
      devices = _coreDevices.default;
    }, function (_coreElement_data) {
      dataUtils = _coreElement_data.default;
    }, function (_coreRenderer) {
      renderer = _coreRenderer.default;
    }, function (_coreUtilsBrowser) {
      browser = _coreUtilsBrowser.default;
    }, function (_coreUtilsCommon) {
      commonUtils = _coreUtilsCommon.default;
      ...
      getOffset = _coreUtilsSize.getOffset;
    }, function (_coreUtilsType) {
      typeUtils = _coreUtilsType.default;
    }, function (_coreUtilsShadow_dom) {
      addShadowDomStyles = _coreUtilsShadow_dom.addShadowDomStyles;
    }, function (_eventsCoreEvents_engine) {
      eventsEngine = _eventsCoreEvents_engine.default;
    }, function (_eventsPointer) {
      pointerEvents = _eventsPointer.default;
    }, function (_eventsVisibility_change) {
      triggerResizeEvent = _eventsVisibility_change.triggerResizeEvent;
    }, function (_generic_lightCss) {}, function (_jquery) {
      $ = _jquery.default;
    }, function (_uiAutocomplete) {}, function (_uiColor_box) {}, function (_uiTag_box) {}, function (_uiData_grid) {}, function (_uiDrop_down_box) {}, function (_uiDrop_down_button) {}, function (_uiSwitch) {}, function (_uiValidator) {}, function (_uiWidgetUiErrors) {
      errors = _uiWidgetUiErrors.default;
    }, function (_helpersDataGridMocksJs) {
      getCells = _helpersDataGridMocksJs.getCells;
      generateItems = _helpersDataGridMocksJs.generateItems;
      MockColumnsController = _helpersDataGridMocksJs.MockColumnsController;
      MockDataController = _helpersDataGridMocksJs.MockDataController;
      setupDataGridModules = _helpersDataGridMocksJs.setupDataGridModules;
    }, function (_helpersPointerMockJs) {
      pointerMock = _helpersPointerMockJs.default;
    }, function (_helpersWrappersDataGridWrappersJs) {
      DataGridWrapper = _helpersWrappersDataGridWrappersJs.default;
    }, function (_helpersDataGridHelperJs) {
      findShadowHostOrDocument = _helpersDataGridHelperJs.findShadowHostOrDocument;
    }, function (_dataData_sourceData_source) {
      DataSource = _dataData_sourceData_source.DataSource;
    }],
    execute: function () {
      QUnit.testStart(function () {
        const markup = '<style nonce="qunit-test">\
    ...
    <div id="container">\
      ...
      QUnit.module('Editing', {
        beforeEach: function () {
          ...
          this.dataControllerOptions = {
            items: [{
              ...
              values: ['test1', 1, new Date(2001, 0, 1), true, true],
              rowType: 'data'
            }, {
              key: 'test2',
              data: {
              ...
              values: ['test2', 2, new Date(2002, 1, 2), false, false],
              rowType: 'data'
            }, {
              key: 'test3',
              data: {
              ...
              values: ['test3', 3, new Date(2003, 2, 3), true, true],
              rowType: 'data'
            }]
          };
          ...
          this.columns = [{
            allowEditing: true,
            dataField: 'name',
            defaultSetCellValue: defaultSetCellValue,
        ...
        QUnit.test('Edit Row and focus not first input', function (assert) {
          ...
          that.keyboardNavigationController._focusedCellPosition = {
            rowIndex: 0,
            columnIndex: 1
          };
          rowsView.render(testElement);
        ...
        QUnit.test('Edit cell on row click when a table is contained inside a cell', function (assert) {
          ...
          rowsView.render(testElement);
          testElement.find('.dx-row:first-child td').eq(1).append($('<table><tr><td><div class="txt"></div></td><td><div class="btn"></div></td></tr></table>'));
        ...
        QUnit.test('Save Row', function (assert) {
          ...
          assert.deepEqual(updateArgs, ['test1', {
        ...
        QUnit.test('Serialize value before saving', function (assert) {
          ...
          assert.deepEqual(updateArgs, ['test1', {
            'name': 'Test update row serialized'
          }]);
        });
        ...
        QUnit.test('Save changes when batch mode when one the changes is canceled from event', function (assert) {
          ...
          assert.deepEqual(that.option('editing.changes'), [{
            key: 'test3',
            type: 'remove'
          }], 'edit data');
        });
        ...
        QUnit.test('Close editing cell when cell is contained table inside', function (assert) {
          ...
          that.columns[0].allowEditing = false;
          rowsView.render(testElement);
          testElement.find('.dx-row:first-child td').eq(1).append($('<table><tr><td><div class="txt"><input></input></div></td><td><div class="btn"></div></td></tr></table>'));
        ...
        QUnit.test('The text of the colorBox should not be overlaps in a grid cell', function (assert) {
          ...
          this.dataControllerOptions.items = [{
            key: 'test1',
            data: {
              name: 'test1',
              color: '#2D4372'
      ...
      QUnit.module('Editing with real dataController', {
        ...
        QUnit.test('Close Editing Cell on hold', function (assert) {
          ...
          // act
          const mouse = pointerMock(testElement.find('tbody td').eq(1)).start().down().wait(750);
          that.clock.tick(750);
          mouse.up();
        ...
        QUnit.test('Edit number cell via keyboard arrows (arrow up key)', function (assert) {
          ...
          $testInput.val('15').trigger($.Event('keydown', {
            key: UP_KEY
          }));
        ...
        QUnit.test('Insert Row when "cell" edit mode and the new value is not accepted yet', function (assert) {
          ...
          // act
          testElement.find('td').first().trigger('dxclick');
          testElement.find('input').first().val('modifiedValue').trigger('change');
          that.addRow();
          this.clock.tick(10);
        ...
        QUnit.test('Update cell when edit mode batch and cancel in onRowUpdating is deferred and resolved', function (assert) {
          ...
          assert.deepEqual(that.dataController.store().update.lastCall.args, [that.array[0], {
            name: 'Test1',
            room: 666
          }], 'update args');
        });
        ...
        QUnit.test('Error during save changes in batch mode', function (assert) {
          ...
          rowsView.render(testElement);
          that.dataController.optionChanged({
            name: 'dataSource'
          });
        ...
        QUnit.test('Get correct first editable column index when form edit mode and form items are changed dynamically', function (assert) {
          ...
          // act
          this.editingController.option('editing.form', {
            items: ['phone', 'room']
          });
          that.editRow(0);
          const editableIndex = this.editingController.getFirstEditableColumnIndex();
        ...
        QUnit.test('Edit row should not throw an exception after change edit mode', function (assert) {
          ...
          try {
            // act
            this.columnsController.optionChanged({
              name: 'editing',
              fullName: 'editing'
            });
            this.editRow(0);
        ...
        QUnit.test('Change value with custom setCellValue', function (assert) {
          ...
          assert.deepEqual(params, [{
            name: 'Test name',
            phone: ''
          }, 'Test name', this.array[0], undefined], 'arguments');
        });
          ...
          try {
            ...
            const onRowRemoving = function (e) {
              setTimeout(() => {
                ...
                that.rowsView.optionChanged({
                  name: 'loadPanel',
                  fullName: 'loadPanel.enabled'
                });
      ...
      QUnit.module('Refresh modes', {
        ...
        QUnit.test('Editing with refresh mode repaint if store returns data', function (assert) {
          ...
          assert.equal(this.loadingArgs.length, 0, 'loading is not occured after editing');
          assert.equal(this.changedArgs.length, 0, 'changed is not occured after editing');
          assert.deepEqual(this.getVisibleRows()[2].data, {
            id: 2,
            name: 'Dan',
            age: 30,
            fromServer: true
          ...
          assert.equal(this.getVisibleRows()[2].values[1], 30, 'row values are updated');
          assert.equal(this.getVisibleRows()[3].data.id, 4, 'row data is removed');
          assert.deepEqual(this.getVisibleRows()[0].data, {
            id: 999,
            name: 'Mike',
            fromServer: true
          }, 'row is inserted to begin and not reshaped');
        ...
        QUnit.test('Changing command column if repaintChangesOnly is true', function (assert) {
          ...
          this.options.columns = [{
            ...
            buttons: [{
              name: 'edit',
              icon: 'active-icon',
              visible: e => e.row.data.state === 'active'
            }, {
              name: 'delete',
              icon: 'remove',
              visible: e => e.row.data.state !== 'active'
              ...
              name: 'custom',
              icon: 'custom',
              disabled: e => e.row.data.state !== 'active'
            }]
          }, 'state'];
          this.options.dataSource = [{
            state: 'disabled'
      ...
      QUnit.module('Editing with validation', {
        ...
        QUnit.test('Keep cell editing when onRowUpdating is canceled (cell edit mode)', function (assert) {
          ...
          that.editingController.optionChanged({
            name: 'onRowUpdating'
          });
        ...
        QUnit.test('CustomRule.validationCallback accepts extra parameters', function (assert) {
          ...
          const rowsView = this.rowsView;
          const testElement = $('#container');
          const validationCallback = sinon.spy(function () {
            return true;
          });
          rowsView.render(testElement);
          this.applyOptions({
        ...
        QUnit.test('Prevent cell validation if template with editor is used', function (assert) {
          ...
          this.options.columns = ['name', {
            ...
            cellTemplate: function (cellElement) {
              const inputDiv = $('<div />');
              inputDiv.dxNumberBox({}).dxValidator({
                validationRules: [{
                  type: 'required'
                }]
              });
        ...
        QUnit.test('The validation message should be decreased when there is not enough visible area', function (assert) {
          ...
          that.applyOptions({
            ...
            columns: [{
              ...
              validationRules: [{
                type: 'required',
                message: 'test test test test test test test test test test'
              }]
            }, {
              dataField: 'lastName',
              width: 50
        ...
        QUnit.test('No exceptions on editing a column with given setCellValue when repaintChangedOnly is true', function (assert) {
          ...
          try {
            ...
            // assert
            $cellElement = $(this.getCellElement(0, 'name')), validator = dataUtils.data($cellElement.find('.dx-texteditor').get(0), 'dxValidator');
        ...
        QUnit.test('validatingController.isInvalidCell - cell should be invalid', function (assert) {
          ...
          // assert
          assert.ok(this.validatingController.isInvalidCell({
            rowKey: key,
            columnIndex: 0
        ...
        QUnit.test('validatingController - validation result should be cached', function (assert) {
          ...
          let result = this.validatingController.getCellValidationResult({
            rowKey,
            columnIndex: 0
          });
          ...
          this.validatingController.updateCellValidationResult({
            rowKey,
            columnIndex: 0,
            validationResult
          });
          result = this.validatingController.getCellValidationResult({
            rowKey,
            columnIndex: 0
          });
        ...
        QUnit.test('validatingController - validation result should be cancelled', function (assert) {
          ...
          this.validatingController.cancelCellValidationResult({
            change,
            columnIndex: 0
          });
          result = this.validatingController.getCellValidationResult({
        ...
        QUnit.test('validatingController - validation result should be removed from cache', function (assert) {
          ...
          assert.ok(result.status, 'result should be restored from cache');
          const change = this.editingController.getChangeByKey(rowKey);
          this.validatingController.removeCellValidationResult({
            change,
            columnIndex: 0
          });
          result = this.validatingController.getCellValidationResult({
        ...
        QUnit.test('validatingController - all validation results of a certain row should be removed', function (assert) {
          ...
          this.saveEditData();
          this.clock.tick(10);
          let result1 = this.validatingController.getCellValidationResult({
            rowKey,
            columnIndex: 0
          });
          let result2 = this.validatingController.getCellValidationResult({
            rowKey,
            columnIndex: 1
          });
          ...
          result1 = this.validatingController.getCellValidationResult({
            rowKey,
            columnIndex: 0
          });
          result2 = this.validatingController.getCellValidationResult({
            rowKey,
            columnIndex: 1
          });
        ...
        QUnit.test('Row - An untouched cell should not be validated (T872003)', function (assert) {
          ...
          const result = this.validatingController.getCellValidationResult({
            rowKey,
            columnIndex: 1
          });
        ...
        QUnit.test('Cell mode(setCellValue) - The value of an invalid dependent cell should be updated in a new row(T872751)', function (assert) {
          ...
          this.clock.tick(10);
          const $inputElement = getInputElements(testElement).first();
          $inputElement.val('testa').trigger('change');
          this.clock.tick(10);
          this.saveEditData();
          const $secondCell = $(this.getCellElement(0, 1));
        ...
        QUnit.test('Cell mode(setCellValue) - The modified data should be saved immediately', function (assert) {
          ...
          assert.deepEqual(this.getDataSource().items()[0], {
            field1: true,
            field2: true
          }, 'data is saved');
        });
        ...
        ['Cell', 'Batch'].forEach(mode => {
          QUnit.test(`${mode} - validationCallback data should contain the entire data item when changes are specified initially (T1010037)`, function (assert) {
            ...
            assert.deepEqual(validationCallback.getCall(0).args[0].data, {
              id: 1,
              name: 'test1',
              description: 'test2'
            }, 'correct data');
        ...
        ['Cell', 'Batch'].forEach(mode => {
          QUnit.test(`${mode} - _getOldData should return correct data when changes are specified initially`, function (assert) {
            ...
            // assert
            assert.deepEqual(this.editingController._getOldData(1), {
              id: 1,
              name: 'test',
              description: 'test2'
            }, 'correct data');
      ...
      generateDataSource = function (countItem, countColumn) {
        const items = [];
      ...
      QUnit.module('Editing with scrolling', {
        ...
        QUnit.test('Position of the inserted row if masterDetail is used', function (assert) {
          ...
          assert.equal(items.filter(function (item) {
            return item.isNewRow;
          })[0].rowIndex, 4, 'insert item');
        });
      ...
      QUnit.module('Edit Form', {
        ...
        QUnit.test('Custom items with editorOptions in column', function (assert) {
          ...
          rowsView.render(testElement);
          that.columnOption(0, 'editorOptions', {
            readOnly: true
          });
        ...
        QUnit.test('Render detail form row - creation a validator should not throw an exception when editCellTemplate specified for column', function (assert) {
          ...
          this.columnOption('phone', {
            editCellTemplate: function ($container, options) {
              return $('<div id=wrapper/>').append($('<div/>').dxAutocomplete({}));
            },
            validationRules: [{
              type: 'required'
            }]
      ...
      QUnit.module('Editing - "popup" mode', {
        beforeEach: function () {
          ...
          this.preparePopupHelpers = function () {
            ...
            this.getEditPopupContent = function () {
              return this.editingController.getPopupContent();
            };
            this.isEditingPopupVisible = function () {
              return this.editPopupInstance.option('visible');
            };
          };
        },
        afterEach: function () {
        ...
        QUnit.test('editing popup toolbarItems option changing should be applied (T862799)', function (assert) {
          ...
          that.editingController.optionChanged({
            name: 'editing',
            fullName: 'editing.popup.toolbarItems[0].options.visible',
            value: true
          });
        ...
        QUnit.testInActiveWindow('Form should repaint after change lookup dataSource', function (assert) {
          ...
          // act
          that.columnOption('room', 'lookup.dataSource', [{
            id: 1,
            name: 'Room 1'
          }, {
            id: 2,
        ...
        QUnit.test('The data passed to the editCellTemplate callback should be updated after editing cell (in the scenario with cascaded editors)', function (assert) {
          ...
          // assert
          assert.deepEqual(template.getCall(0).args[1].data, {
            name: 'Alex',
            age: 15,
            lastName: 'John',
            phone: '555555',
          ...
          // assert
          assert.deepEqual(template.getCall(1).args[1].data, {
            name: 'Alex',
            age: 666,
            lastName: 'John',
            phone: '555555',
        ...
        QUnit.test('In popup editing mode need to repaint only changed fields with repaintChangesOnly (T753269)', function (assert) {
          ...
          that.options.columns = ['Id', 'Name', {
            dataField: 'City',
            lookup: getLookupConfig(cities, 'City')
          }, {
            dataField: 'Country',
            lookup: getLookupConfig(countries, 'Country')
          }];
      ...
      QUnit.module('Promises in callbacks and events', {
        ...
        QUnit.test('Adding multiple rows with async onInitNewRow and batch mode', function (assert) {
          ...
          assert.deepEqual(visibleRows[7].data, {
            room: 8
          }, 'row #7 data');
          assert.deepEqual(visibleRows[8].data, {
            room: 9
          }, ' row #8 data');
          assert.deepEqual(visibleRows[9].data, {
            room: 10
          }, 'last row\'s data');
      ...
      QUnit.module('Editing - public arguments of the events/templates', {
        ...
        ['row', 'batch', 'cell', 'form', 'popup'].forEach(editMode => {
          ...
          QUnit.test(`Check arguments of the editCellTemplate in ${editMode} mode`, function (assert) {
            ...
            this.columns[0] = {
              dataField: 'name',
              editCellTemplate: editCellTemplateSpy
            };
            this.setupModules();
            this.renderRowsView();
          ...
          QUnit.test(`${editMode} mode - onRowInserting/onRowInserted should have correct arguments when inserting row via 'editing.changes' option`, function (assert) {
            ...
            assert.deepEqual(onRowInsertingSpy.getCall(0).args[0], {
              cancel: false,
              data: {
                id: 123,
                name: 'new'
              }
            }, 'onRowInserting event - args');
            assert.deepEqual(onRowInsertedSpy.getCall(0).args[0], {
              key: 123,
              data: {
                id: 123,
                name: 'new'
              }
            }, 'onRowInserted event - args');
          });
          ...
          QUnit.test(`${editMode} mode - onRowUpdating/onRowUpdated should have correct arguments when updating row via 'editing.changes' option`, function (assert) {
            ...
            assert.deepEqual(onRowUpdatingSpy.getCall(0).args[0], {
              cancel: false,
              key: 1,
              newData: {
                name: 'update'
            ...
            }, 'onRowUpdating event - args');
            assert.deepEqual(onRowUpdatedSpy.getCall(0).args[0], {
              key: 1,
              data: {
                id: 1,
                name: 'update'
              }
            }, 'onRowUpdated event - args');
          });
          ...
          QUnit.test(`${editMode} mode - onRowRemoving/onRowRemoved should have correct arguments when removing row via 'editing.changes' option`, function (assert) {
            ...
            assert.deepEqual(onRowRemovingSpy.getCall(0).args[0], {
              cancel: false,
              key: 1,
              data: items[1]
            }, 'onRowRemoving event - args');
            assert.deepEqual(onRowRemovedSpy.getCall(0).args[0], {
              key: 1,
              data: items[1]
            }, 'onRowRemoved event - args');
          });
