System.register(["jquery", "data/data_source/data_source", "core/utils/type", "core/utils/common", "core/config", "core/devices", "core/utils/resize_callbacks", "ui/widget/ui.errors", "../../../helpers/executeAsyncMock.js", "animation/fx", "events/hold", "../../../helpers/keyboardMock.js", "../../../helpers/pointerMock.js", "core/component_registrator", "events/swipe", "ui/themes", "data/array_store", "data/custom_store", "core/dom_component", "ui/list", "ui/list/ui.list.base", "ui/scroll_view", "events/core/events_engine", "../../../helpers/ariaAccessibilityTestHelper.js", "../scrollableParts/scrollable.constants.js", "./utils.js"], function (_export, _context) {
  "use strict";

  var $, DataSource, isRenderer, noop, config, devices, resizeCallbacks, errors, executeAsyncMock, fx, holdEvent, keyboardMock, pointerMock, registerComponent, swipeEvents, themes, ArrayStore, CustomStore, DOMComponent, List, setScrollView, ScrollView, eventsEngine, ariaAccessibilityTestHelper, RESIZE_WAIT_TIMEOUT, reorderingPointerMock, LIST_ITEM_CLASS, LIST_GROUP_CLASS, LIST_GROUP_HEADER_CLASS, LIST_GROUP_BODY_CLASS, LIST_NEXT_BUTTON_CLASS, LIST_SELECT_CHECKBOX_CLASS, LIST_SELECT_RADIOBUTTON_CLASS, LIST_SELECT_ALL_CHECKBOX_CLASS, LIST_CONTEXT_MENUCONTENT_CLASS, LIST_SELECT_ALL_LABEL_CLASS, INKRIPPLE_WAVE_SHOWING_CLASS, LIST_ITEM_CHEVRON_CLASS, LIST_ITEM_BADGE_CLASS, LIST_ITEM_SELECTED_CLASS, toSelector, isDeviceDesktop, getListKeyboard, ScrollViewMock, showListSlideMenu, showListContextMenu, moduleSetup, LIST_GROUP_COLLAPSED_CLASS, LIST_COLLAPSIBLE_GROUPS_CLASS, helper;
  return {
    setters: [function (_jquery) {
      ...
      isRenderer = _coreUtilsType.isRenderer;
    ...
    }, function (_coreUtilsResize_callbacks) {
      resizeCallbacks = _coreUtilsResize_callbacks.default;
    }, function (_uiWidgetUiErrors) {
      errors = _uiWidgetUiErrors.default;
    }, function (_helpersExecuteAsyncMockJs) {
      executeAsyncMock = _helpersExecuteAsyncMockJs.default;
    }, function (_animationFx) {
      fx = _animationFx.default;
    }, function (_eventsHold) {
      holdEvent = _eventsHold.default;
    ...
    }, function (_coreComponent_registrator) {
      registerComponent = _coreComponent_registrator.default;
    }, function (_eventsSwipe) {
      swipeEvents = _eventsSwipe.default;
    }, function (_uiThemes) {
      themes = _uiThemes.default;
    }, function (_dataArray_store) {
      ArrayStore = _dataArray_store.default;
    }, function (_dataCustom_store) {
      CustomStore = _dataCustom_store.default;
    }, function (_coreDom_component) {
      DOMComponent = _coreDom_component.default;
    }, function (_uiList) {
      List = _uiList.default;
    }, function (_uiListUiListBase) {
      setScrollView = _uiListUiListBase.setScrollView;
    ...
    }, function (_helpersAriaAccessibilityTestHelperJs) {
      ariaAccessibilityTestHelper = _helpersAriaAccessibilityTestHelperJs.default;
    }, function (_scrollablePartsScrollableConstantsJs) {
      RESIZE_WAIT_TIMEOUT = _scrollablePartsScrollableConstantsJs.RESIZE_WAIT_TIMEOUT;
    }, function (_utilsJs) {
      reorderingPointerMock = _utilsJs.reorderingPointerMock;
    }],
    execute: function () {
      ...
      LIST_SELECT_CHECKBOX_CLASS = 'dx-list-select-checkbox';
      LIST_SELECT_RADIOBUTTON_CLASS = 'dx-list-select-radiobutton';
      LIST_SELECT_ALL_CHECKBOX_CLASS = 'dx-list-select-all-checkbox';
      LIST_CONTEXT_MENUCONTENT_CLASS = 'dx-list-context-menucontent';
      LIST_SELECT_ALL_LABEL_CLASS = 'dx-list-select-all-label';
      ...
      getListKeyboard = $list => {
        return keyboardMock($list.find('[tabindex=0]'));
      };
      ScrollViewMock = DOMComponent.inherit({
        NAME: 'dxScrollView',
      ...
      QUnit.module('options changed', moduleSetup, () => {
        ...
        QUnit.test('searchExpr', function (assert) {
          ...
          const instance = $element.dxList('instance');
          assert.deepEqual(instance.option('items'), [{
            text: 'test3',
            value: '2'
          }], 'items');
        ...
        QUnit.test('searchEditorOptions', function (assert) {
          ...
          instance.option('searchEditorOptions', {
            placeholder: 'Test'
          });
      ...
      QUnit.module('events', moduleSetup, () => {
        ...
        QUnit.test('onItemRendered should have correct itemIndex parameter when data is grouped (T989015)', function (assert) {
          ...
          const {
            itemIndex
          } = itemRenderedStub.getCall(0).args[0];
          assert.deepEqual(itemIndex, {
            group: 0,
            item: 0
          });
        });
      ...
      QUnit.module('scrollView integration', {
        ...
        [{
          listOption: 'showScrollbar',
          scrollViewOption: 'showScrollbar'
        }, {
          listOption: 'bounceEnabled',
          scrollViewOption: 'bounceEnabled'
        }, {
          listOption: 'scrollByContent',
          scrollViewOption: 'scrollByContent'
        }, {
          listOption: 'scrollByThumb',
          scrollViewOption: 'scrollByThumb'
        }, {
          listOption: 'useNativeScrolling',
          scrollViewOption: 'useNative'
        }, {
          listOption: 'scrollingEnabled',
          scrollViewOption: 'disabled',
          reverted: true
        }].forEach(optionInfo => {
        ...
        [{
          listOption: 'pulledDownText',
          scrollViewOption: 'pulledDownText'
        }, {
          listOption: 'pullingDownText',
          scrollViewOption: 'pullingDownText'
        }, {
          listOption: 'refreshingText',
          scrollViewOption: 'refreshingText'
        }, {
          listOption: 'pageLoadingText',
          scrollViewOption: 'reachBottomText'
        }].forEach(optionInfo => {
        ...
        QUnit.test('list should load new items if the new height allows it', function (assert) {
          ...
          const listHeight = 60;
          const $container = $('#list').wrap('<div>').parent().height(listHeight);
          const $list = $('#list').dxList({
            height: '100%',
            dataSource,
            pageLoadMode: 'scrollBottom'
      ...
      QUnit.module('regressions', moduleSetup, () => {
        ...
        QUnit.test('onItemClick on disabled items', function (assert) {
          ...
          let item = element.find(toSelector(LIST_ITEM_CLASS)).last();
          item.trigger('dxclick');
      ...
      QUnit.module('keyboard navigation', {
        ...
        QUnit.test('list should attach keyboard events even if focusStateEnabled is false when the widget\'s onKeyboardHandled is defined', function (assert) {
          ...
          $itemContainer.trigger($.Event('keydown', {
            key: 'Enter'
          }));
          ...
          QUnit.module(`Aria accessibility, searchEnabled: ${searchEnabled}`, {
            beforeEach: function () {
              helper = new ariaAccessibilityTestHelper({
                createWidget: ($element, options) => new List($element, $.extend({
                  items: [{
                    text: 'Item_1'
                  }, {
                    text: 'Item_2'
            ...
            QUnit.test('Selected: ["Item_1", "Item_3"] -> select "Item_2" by click', function () {
              helper.createWidget({
                selectedItemKeys: ['Item_1', 'Item_3'],
                keyExpr: 'text',
                selectionMode: 'multiple'
              });
              helper.checkAttributes(helper.$itemContainer, this.expectedItemContainerAttrs);
              ...
              helper.checkItemsAttributes([0, 1, 2], {
                attributes: ['aria-selected'],
                focusedItemIndex: 1,
                role: 'option'
              });
