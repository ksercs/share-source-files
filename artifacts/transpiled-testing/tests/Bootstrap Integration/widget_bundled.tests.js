...
(["testing/tests/Bootstrap Integration/widget_bundled.tests.js"], ["jquery","ui/map/provider.google_static","animation/fx","../../helpers/executeAsyncMock.js","generic_light.css!","bundles/modules/parts/widgets-web"], true, function($__System) {
var require = this.require, exports = this.exports, module = this.module;
$__System.registerDynamic('testing/tests/Bootstrap Integration/widget_bundled.tests.js', ['jquery', 'ui/map/provider.google_static', 'animation/fx', '../../helpers/executeAsyncMock.js', 'generic_light.css!', 'bundles/modules/parts/widgets-web'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    const $ = $__require('jquery');
    const GoogleStaticProvider = $__require('ui/map/provider.google_static');
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["jquery","ui/map/provider.google_static","animation/fx","../../helpers/executeAsyncMock.js","generic_light.css!","bundles/modules/parts/widgets-web"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("jquery"), require("ui/map/provider.google_static"), require("animation/fx"), require("../../helpers/executeAsyncMock.js"), require("generic_light.css!"), require("bundles/modules/parts/widgets-web"));
  else
    throw new Error("Module must be loaded as AMD or CommonJS");
});
//# sourceMappingURL=widget_bundled.tests.js.map