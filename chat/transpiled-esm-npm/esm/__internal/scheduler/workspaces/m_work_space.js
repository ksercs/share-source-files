...
import { drop as dragEventDrop, enter as dragEventEnter, leave as dragEventLeave } from '../../../common/core/events/drag';
...
class SchedulerWorkSpace extends WidgetObserver {
  ...
  _createDragBehaviorBase(targetElement, rootElement, options) {
    ...
    this.dragBehavior.addTo(targetElement, createDragBehaviorConfig(container, rootElement, this.isDefaultDraggingMode, this.dragBehavior, enableDefaultDragging, disableDefaultDragging, () => this.getDroppableCell(), () => this._getDateTables(), () => this.removeDroppableCellClass(), () => this.getCellWidth(), options));
  }
  // --------------
  ...
  _createHeaderScrollable() {
    const $headerScrollable = $('<div>').addClass(SCHEDULER_HEADER_SCROLLABLE_CLASS).appendTo(this._$headerTablesContainer);
    // @ts-expect-error
  ...
  _createSidebarScrollable() {
    const $timePanelScrollable = $('<div>').addClass(SCHEDULER_SIDEBAR_SCROLLABLE_CLASS).appendTo(this._$flexContainer);
    // @ts-expect-error
  ...
  _removeAllDayElements() {
    ...
    (_this$_$allDayTable = this._$allDayTable) === null || _this$_$allDayTable === void 0 || _this$_$allDayTable.remove();
    (_this$_$allDayTitle = this._$allDayTitle) === null || _this$_$allDayTitle === void 0 || _this$_$allDayTitle.remove();
  }
  _cleanView() {
    var _this$_shader;
    this.cache.clear();
    ...
    if (!this.isRenovatedRender()) {
      ...
      (_this$_$allDayTable2 = this._$allDayTable) === null || _this$_$allDayTable2 === void 0 || _this$_$allDayTable2.empty();
  ...
  _cleanTableWidths() {
    ...
    (_this$_$allDayTable3 = this._$allDayTable) === null || _this$_$allDayTable3 === void 0 || _this$_$allDayTable3.css('width', '');
  }
...
const createDragBehaviorConfig = (container, rootElement, isDefaultDraggingMode, dragBehavior, enableDefaultDragging, disableDefaultDragging, getDroppableCell, getDateTables, removeDroppableCellClass, getCellWidth, options) => {
  ...
  const getElementsFromPoint = () => {
    ...
    if (isWideAppointment) {
      return domAdapter.elementsFromPoint(newX + DRAGGING_MOUSE_FAULT, newY + DRAGGING_MOUSE_FAULT, dragElementContainer);
    }
    if (isNarrowAppointment) {
      return domAdapter.elementsFromPoint(newX, newY, dragElementContainer);
    }
    return domAdapter.elementsFromPoint(newX + appointmentWidth / 2, newY + DRAGGING_MOUSE_FAULT, dragElementContainer);
  };
  const onDragMove = () => {
    if (isDefaultDraggingMode) {
      return;
  ...
  const onDragCancel = e => {
    ...
    removeDroppableCellClass();
    (_e$itemElement = e.itemElement) === null || _e$itemElement === void 0 || (_e$itemElement$remove = _e$itemElement.removeClass) === null || _e$itemElement$remove === void 0 || _e$itemElement$remove.call(_e$itemElement, APPOINTMENT_DRAG_SOURCE_CLASS);
  };
