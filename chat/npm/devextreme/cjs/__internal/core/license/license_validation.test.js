...
(0, _globals.describe)('version mismatch', () => {
  ...
  (0, _globals.test)('Perform version comparison if the license is okay', () => {
    ...
    (0, _globals.expect)((_errorsLogMock = errorsLogMock) === null || _errorsLogMock === void 0 ? void 0 : _errorsLogMock.mock.calls.length).toEqual(1);
    (0, _globals.expect)((_errorsLogMock2 = errorsLogMock) === null || _errorsLogMock2 === void 0 ? void 0 : _errorsLogMock2.mock.calls[0][0]).toEqual('W0023');
  });
  _globals.test.each([[[{
    name: 'A',
    version: '24.2.2'
    ...
    (0, _license_validation.validateLicense)(token, CORRECT_VERSION);
    (0, _globals.expect)((_errorsLogMock3 = errorsLogMock) === null || _errorsLogMock3 === void 0 ? void 0 : _errorsLogMock3.mock.calls.length).toEqual(1);
    (0, _globals.expect)((_errorsLogMock4 = errorsLogMock) === null || _errorsLogMock4 === void 0 ? void 0 : _errorsLogMock4.mock.calls[0][0]).toEqual('W0023');
  });
  _globals.test.each([[[{
    name: 'A',
    version: '24.2.2'
...
(0, _globals.describe)('license check', () => {
  ...
  (0, _globals.test)('Trial panel "Buy Now" link must use the jQuery link if no config has been set', () => {
    ...
    (0, _globals.expect)((_trialPanelSpy = trialPanelSpy) === null || _trialPanelSpy === void 0 ? void 0 : _trialPanelSpy.mock.calls[0][0]).toBe('https://go.devexpress.com/Licensing_Installer_Watermark_DevExtremeJQuery.aspx');
  });
  (0, _globals.test)('Trial panel "Buy Now" link must use the value from the config', () => {
    ...
    (0, _license_validation.validateLicense)('', '1.2');
    (0, _globals.expect)((_trialPanelSpy2 = trialPanelSpy) === null || _trialPanelSpy2 === void 0 ? void 0 : _trialPanelSpy2.mock.calls[0][0]).toBe('trial-panel-link.com');
  });
