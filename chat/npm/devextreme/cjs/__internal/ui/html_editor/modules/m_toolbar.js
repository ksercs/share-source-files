...
if (_devextremeQuill.default) {
  ...
  ToolbarModule = class ToolbarModule extends _m_base.default {
    ...
    _createCommandMenuItem(command, text, commandOptions) {
      ...
      const options = commandOptions ?? ((_getDefaultOptionsByC = (0, _ai.getDefaultOptionsByCommand)(command)) === null || _getDefaultOptionsByC === void 0 ? void 0 : _getDefaultOptionsByC.map(_capitalize.capitalize));
      return {
        id: command,
        ...
        if (typeof command === 'object') {
          if (command.name === 'custom') {
            ...
            return {
              id: 'custom',
              text: command.text,
              items: (_command$options = command.options) === null || _command$options === void 0 ? void 0 : _command$options.map(option => ({
                parentCommand: 'custom',
                id: option,
                text: option,
                options: command.options.map(_capitalize.capitalize),
                prompt
              })),
