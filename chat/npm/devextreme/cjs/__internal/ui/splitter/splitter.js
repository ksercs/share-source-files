...
class Splitter extends _m_collection_widget.default {
  ...
  _itemVisibleOptionChanged(item) {
    ...
    let prevValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  ...
  _getDistributionData(item, value) {
    ...
    const direction = isLastVisible === (value === false) ? _types.CollapseExpandDirection.Next : _types.CollapseExpandDirection.Previous;
