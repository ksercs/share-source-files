...
const equalFilterParameters = function (filter1, filter2, langParams) {
  ...
  if ((0, _type.isFunction)(filter1) && filter1.columnIndex >= 0 && (0, _type.isFunction)(filter2) && filter2.columnIndex >= 0) {
    return filter1.columnIndex === filter2.columnIndex && (0, _data.toComparable)(filter1.filterValue, undefined, langParams) === (0, _data.toComparable)(filter2.filterValue, undefined, langParams) && (0, _data.toComparable)(filter1.selectedFilterOperation, undefined, langParams) === (0, _data.toComparable)(filter2.selectedFilterOperation, undefined, langParams);
  }
  return (0, _data.toComparable)(filter1, undefined, langParams) == (0, _data.toComparable)(filter2, undefined, langParams); // eslint-disable-line eqeqeq
};
