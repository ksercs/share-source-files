  ...
  calculateSearchFilter(text, langParams) {
    ...
    for (let i = 0; i < columns.length; i++) {
      ...
      if (allowSearch(column) && column.calculateFilterExpression) {
        ...
        if ((_lookup = lookup) !== null && _lookup !== void 0 && _lookup.items) {
          // @ts-expect-error
...
const rowsView = Base => class SearchRowsViewExtender extends Base {
  ...
  _getStringNormalizer() {
    ...
    const dataSource = (_this$_dataController3 = this._dataController) === null || _this$_dataController3 === void 0 || (_this$_dataController4 = _this$_dataController3.getDataSource) === null || _this$_dataController4 === void 0 ? void 0 : _this$_dataController4.call(_this$_dataController3);
    const langParams = dataSource === null || dataSource === void 0 || (_dataSource$loadOptio2 = dataSource.loadOptions) === null || _dataSource$loadOptio2 === void 0 || (_dataSource$loadOptio2 = _dataSource$loadOptio2.call(dataSource)) === null || _dataSource$loadOptio2 === void 0 ? void 0 : _dataSource$loadOptio2.langParams;
