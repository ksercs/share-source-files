...
import { isMaterial, isMaterialBased,
// @ts-expect-error
...
class ToolbarBase extends CollectionWidgetAsync {
  ...
  _alignCenterSection(beforeRect, afterRect, elementWidth) {
    ...
    const centerRect = getBoundingRect((_this$_$centerSection = this._$centerSection) === null || _this$_$centerSection === void 0 ? void 0 : _this$_$centerSection.get(0));
