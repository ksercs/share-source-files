...
export class Scroller extends Class.inherit({}) {
  ...
  _isScrollbar($element) {
    return this._scrollByThumb && ($element === null || $element === void 0 ? void 0 : $element.is(this._$scrollbar));
  }
  _reachedMin() {
...
export class SimulatedStrategy extends Class.inherit({}) {
  ...
  handleEnd(e) {
    ...
    this._resetActive();
    this._refreshCursorState((_e$originalEvent = e.originalEvent) === null || _e$originalEvent === void 0 ? void 0 : _e$originalEvent.target);
