...
if (Quill) {
  ...
  ToolbarModule = class ToolbarModule extends BaseModule {
    ...
    _createCommandMenuItem(command, text, commandOptions) {
      ...
      const options = commandOptions ?? ((_getDefaultOptionsByC = getDefaultOptionsByCommand(command)) === null || _getDefaultOptionsByC === void 0 ? void 0 : _getDefaultOptionsByC.map(capitalize));
      return {
        id: command,
