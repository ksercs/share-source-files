...
class Calendar extends Editor {
  ...
  _dateOption(optionName, optionValue) {
    ...
    const serializedValue = isArray ? (optionValue === null || optionValue === void 0 ? void 0 : optionValue.map(value => dateSerialization.serializeDate(value, serializationFormat))) || [] : dateSerialization.serializeDate(optionValue, serializationFormat);
  ...
  _initTemplates() {
    this._templateManager.addDefaultTemplates({
      ...
      cell: new FunctionTemplate(options => {
        ...
        $(options.container).append($('<span>').text((data === null || data === void 0 ? void 0 : data.text) || String(data)));
      })
    });
