...
const data = Base => class DataSelectionTreeListExtender extends dataSelectionExtenderMixin(Base) {
...
const columnHeadersView = Base => class ColumnHeaderViewSelectionTreeListExtender extends columnHeadersSelectionExtenderMixin(Base) {
...
const rowsView = Base => class RowsViewSelectionTreeListExtender extends rowsViewSelectionExtenderMixin(Base) {
