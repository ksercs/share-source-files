...
import { isNumeric, isRenderer, isString, isWindow } from '../../../core/utils/type';
...
export const getVisibleHeight = function (element) {
  if (element) {
    ...
    const boundingClientRect = (_element$getBoundingC = element.getBoundingClientRect) === null || _element$getBoundingC === void 0 ? void 0 : _element$getBoundingC.call(element);
    if (boundingClientRect !== null && boundingClientRect !== void 0 && boundingClientRect.height) {
