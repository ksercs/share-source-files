...
import { convertPrimitiveValue, escapeServiceOperationParams, formatFunctionInvocationUrl, generateExpand, generateSelect, serializeKey } from './m_utils';
...
const ODataStore = Store.inherit({
  ...
  createQuery(loadOptions) {
    ...
    if (loadOptions !== null && loadOptions !== void 0 && loadOptions.customQueryParams) {
      const params = escapeServiceOperationParams(loadOptions === null || loadOptions === void 0 ? void 0 : loadOptions.customQueryParams, this.version());
      if (this.version() === 4) {
