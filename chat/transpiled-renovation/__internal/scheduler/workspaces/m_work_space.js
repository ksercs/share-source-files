...
class SchedulerWorkSpace extends _m_widget_observer.default {
  ...
  _createDragBehavior($targetElement, $rootElement) {
    ...
    const getItemSettings = $itemElement => $itemElement.data(_constants.APPOINTMENT_SETTINGS_KEY);
    const options = {
      getItemData,
      getItemSettings
    };
...
const createDragBehaviorConfig = (container, rootElement, isDefaultDraggingMode, dragBehavior, enableDefaultDragging, disableDefaultDragging, getDroppableCell, getDateTables, removeDroppableCellClass, getCellWidth, options) => {
  ...
  const onDragCancel = e => {
    ...
    removeDroppableCellClass();
    (_e$itemElement = e.itemElement) === null || _e$itemElement === void 0 || (_e$itemElement$remove = _e$itemElement.removeClass) === null || _e$itemElement$remove === void 0 || _e$itemElement$remove.call(_e$itemElement, _m_classes.APPOINTMENT_DRAG_SOURCE_CLASS);
  };
