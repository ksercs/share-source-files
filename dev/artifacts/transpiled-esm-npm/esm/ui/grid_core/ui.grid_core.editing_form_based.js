      ...
      editing: {
        ...
        _handleDataChanged: function _handleDataChanged(args) {
          if (this.isPopupEditMode()) {
            ...
            var hasEditRow = args === null || args === void 0 ? void 0 : (_args$items = args.items) === null || _args$items === void 0 ? void 0 : _args$items.some(item => equalByValue(item.key, editRowKey));
            var onlyInsertChanges = ((_args$changeTypes = args.changeTypes) === null || _args$changeTypes === void 0 ? void 0 : _args$changeTypes.length) && args.changeTypes.every(item => item === 'insert');
        ...
        _handleFormOptionChange: function _handleFormOptionChange(args) {
          ...
          } else if ((_this$_editPopup5 = this._editPopup) !== null && _this$_editPopup5 !== void 0 && _this$_editPopup5.option('visible') && args.fullName.indexOf(EDITING_FORM_OPTION_NAME) === 0) {
            this._repaintEditPopup();
          }
        },
        ...
        getEditFormTemplate: function getEditFormTemplate() {
          return ($container, detailOptions, options) => {
            ...
            this._editForm.on('contentReady', () => {
              ...
              this._rowsView.renderDelayedTemplates();
              (_this$_editPopup6 = this._editPopup) === null || _this$_editPopup6 === void 0 ? void 0 : _this$_editPopup6.repaint();
            });
          };
        },
        ...
        _beforeEndSaving: function _beforeEndSaving() {
          ...
          if (this.isPopupEditMode()) {
            ...
            (_this$_editPopup7 = this._editPopup) === null || _this$_editPopup7 === void 0 ? void 0 : _this$_editPopup7.hide();
          }
        },
