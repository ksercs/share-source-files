...
const keyboardNavigationMembers = {
    ...
    _resetFocusedCell(preventScroll) {
        ...
        this._focusedCellPosition = {};
        clearTimeout(this._updateFocusTimeout);
        (_a = this._focusedView) === null || _a === void 0 ? void 0 : _a.renderFocusState({ preventScroll });
    },
    ...
    _fireFocusedRowChanged($rowElement) {
        ...
        const focusedRowIndex = focusController === null || focusController === void 0 ? void 0 : focusController.getFocusedRowIndexByKey(focusedRowKey);
        if (this.option('focusedRowEnabled')) {
        ...
        views: {
            rowsView: {
                ...
                renderFocusState(params) {
                    const { preventScroll, pageSizeChanged } = params !== null && params !== void 0 ? params : {};
                    const keyboardController = this.getController('keyboardNavigation');
                ...
                _renderFocusByChange(change) {
                    const { operationTypes, repaintChangesOnly } = change !== null && change !== void 0 ? change : {};
                    const { fullReload, pageSize } = operationTypes !== null && operationTypes !== void 0 ? operationTypes : {};
