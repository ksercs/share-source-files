        ...
        controllers: {
                ...
                _afterSaveEditData(cancel) {
                    ...
                    if (cancel && isCellEditMode && this._needUpdateRow()) {
                        ...
                        if (isCellEditMode) {
                            ...
                            const columnsWithValidatingEditors = columns.filter((col) => { var _a; return col.showEditorAlways && ((_a = col.validationRules) === null || _a === void 0 ? void 0 : _a.length) > 0; }).length > 0;
            ...
            data: {
                ...
                _isCellChanged(oldRow, newRow, visibleRowIndex, columnIndex, isLiveUpdate) {
                    ...
                    const oldValidationStatus = this._getValidationStatus({ status: cell === null || cell === void 0 ? void 0 : cell.validationStatus });
                    const validatingController = this.getController('validating');
