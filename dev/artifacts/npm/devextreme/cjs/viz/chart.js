...
var dxChart = _advanced_chart.AdvancedChart.inherit({
  ...
  _hidePointsForSingleSeriesIfNeeded: function _hidePointsForSingleSeriesIfNeeded(series) {
  ...
  _applyAutoHidePointMarkers: function _applyAutoHidePointMarkers(filteredSeries) {
