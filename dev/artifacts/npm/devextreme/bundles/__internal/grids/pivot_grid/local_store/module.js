...
var LocalStore = class_1.default.inherit((function () {
    ...
    function getDataSelector(dataField) {
        return dataField.indexOf('.') !== -1 ? data_1.compileGetter(dataField) : function (data) { return data[dataField]; };
    }
        ...
        iterator_1.each(fields || [], function (_, field) {
            ...
            if (!field.selector) {
                ...
                if (field.dataType === 'date') {
                    ...
                    groupInterval = type_1.isNumeric(field.groupInterval)
    ...
    function aggregationFinalize(measures, cells) {
        iterator_1.each(measures, function (aggregatorIndex, cellField) {
            var aggregator = getAggregator(cellField);
    ...
    function createFilter(options) {
        var filters = createDimensionFilters(options.rows)
    ...
    function fillSelectorsByFields(selectors, fields) {
        fields.forEach(function (field) {
            if (field.dataField && field.dataType === 'date') {
                ...
                selectors[field.dataField] = function (data) { return valueSelector_2(data); };
            }
        });
    }
...
exports.default = { LocalStore: LocalStore };
