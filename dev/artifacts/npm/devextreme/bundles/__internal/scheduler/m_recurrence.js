...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } /* eslint-disable max-classes-per-file, spellcheck/spell-checker */
...
var RecurrenceProcessor = /*#__PURE__*/function () {
  ...
  _proto._convertRruleResult = function _convertRruleResult(rruleIntervalParams, options, rruleDate) {
    var localTimezoneOffset = _m_utils_time_zone.default.getClientTimezoneOffset(rruleDate);
    ...
    var convertedBackDate = _m_utils_time_zone.default.setOffsetsToDate(rruleDate, [localTimezoneOffset, additionalWorkaroundOffsetForRrule, -options.appointmentTimezoneOffset, rruleIntervalParams.startIntervalDateDSTShift]);
