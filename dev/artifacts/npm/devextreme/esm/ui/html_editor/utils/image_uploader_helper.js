...
class UpdateUrlStrategy extends AddUrlStrategy {
  ...
  modifyFormData() {
    ...
    if (imgElement) {
      ...
      this.formData.width = (_this$formData$width = this.formData.width) !== null && _this$formData$width !== void 0 ? _this$formData$width : getWidth($(imgElement));
      this.formData.height = (_this$formData$height = this.formData.height) !== null && _this$formData$height !== void 0 ? _this$formData$height : getHeight($(imgElement));
    }
  }
  pasteImage(formData, event) {
