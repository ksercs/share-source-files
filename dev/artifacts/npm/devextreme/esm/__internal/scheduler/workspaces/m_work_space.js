...
import { locate, resetPosition } from '../../../animation/translator';
...
import { drop as dragEventDrop, enter as dragEventEnter, leave as dragEventLeave } from '../../../events/drag';
...
import { DATE_TABLE_CLASS, DATE_TABLE_ROW_CLASS, FIXED_CONTAINER_CLASS, GROUP_HEADER_CONTENT_CLASS, GROUP_ROW_CLASS, TIME_PANEL_CLASS, VERTICAL_GROUP_COUNT_CLASSES, VIRTUAL_CELL_CLASS } from '../m_classes';
import { APPOINTMENT_SETTINGS_KEY } from '../m_constants';
import tableCreatorModule from '../m_table_creator';
import { utils } from '../m_utils';
import { createResourcesTree, getCellGroups, getGroupCount, getGroupsObjectFromGroupsArray } from '../resources/m_utils';
...
class SchedulerWorkSpace extends WidgetObserver {
  ...
  _supportedKeys() {
    ...
    var onArrowPressed = (e, key) => {
      ...
      e.preventDefault();
      e.stopPropagation();
      var focusedCellData = (_a = this.cellsSelectionState.focusedCell) === null || _a === void 0 ? void 0 : _a.cellData;
      if (focusedCellData) {
  ...
  _attachDragEvents(element) {
    ...
    var onCheckDropTarget = (target, event) => !this._isOutsideScrollable(target, event);
